...
<cfoutput>
	...
	<cfset templateHeader=" part_id,part_name,condition,disposition,lot_count,remarks">
</cfoutput>
...
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>yes</td>
		<td>
			part identifier, available from Parts table/download (among other places)
		</td>
	</tr>
	<tr>
		<td>part_name</td>
	...
	<tr>
		...
		<td>no</td>
		<td>
			NULL to do nothing; value from <a href="/info/ctDocumentation.cfm?table=ctcoll_obj_disp">ctcoll_obj_disp</a> to change.
		</td>
	</tr>
	<tr>
		<td>lot_count</td>
