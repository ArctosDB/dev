	...
	<cfoutput>
		<cfquery name="up" datasource="uam_god">
			update cf_ctuser_roles set
				AV_DOCUMENTATION=<cfqueryparam value="#AV_DOCUMENTATION#" CFSQLType="cf_sql_varchar">,
				DESCRIPTION=<cfqueryparam value="#DESCRIPTION#" CFSQLType="cf_sql_varchar">,
				REQUIRED_READING=<cfqueryparam value="#REQUIRED_READING#" CFSQLType="cf_sql_varchar">,
				TEXT_DOCUMENTATION=<cfqueryparam value="#TEXT_DOCUMENTATION#" CFSQLType="cf_sql_varchar">
				SHARED=<cfqueryparam value="#SHARED#" CFSQLType="cf_sql_varchar">,
				USER_TYPE=<cfqueryparam value="#USER_TYPE#" CFSQLType="cf_sql_varchar">
			where
		...
		<table border>
			...
			<cfloop query="dt">
				<cfquery name="dts" dbtype="query">
					select privilege_type from d where table_name='#table_name#'
				</cfquery>
