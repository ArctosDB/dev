...
<cfoutput>
	...
	It has come to our attention that not all API calls are properly documented, and some API functions in fact control UI (not useful for API users). This section is intended to remedy that to the greatest extent possible.
	...
	<p>
		The following links should be instructive, but are not all-encompassing. You will need to ajust "placeholders" as listed below.
	</p>
	<ul>
		<li>
