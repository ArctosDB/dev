...
<cfif isdefined("table")>
	...
	<cfelseif table is "ctspecimen_part_name">
		<cfquery name="ctspecimen_part_name" datasource="cf_codetables" cachedwithin="#createtimespan(0,0,60,0)#">
			select * from ctspecimen_part_name <cfif len(coln) gt 0> where collection_cde=<cfqueryparam value = "#coln#" CFSQLType="CF_SQL_VARCHAR" ></cfif> order by part_name,collection_cde
		</cfquery>
