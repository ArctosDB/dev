...
<!------------------------Agent Arctos Activity------------------------------------------->
    ...
    <!------------------------Catalog Records Edited by Agent------------------------------------------->
    ...
    <cfif last_edit.cnt gt 0>
        <h4>
            Catalog Records Edited by #agent.PREFERRED_AGENT_NAME#
        </h4>
        <ul>
            <cfloop query="last_edit">
                <li>
                    <a href="/search.cfm?edited_by_id=#agent_id#&collection_id=#collection_id#">#cnt# #guid_prefix#</a> catalog records
                </li>
            </cfloop>
        </ul>
    </cfif>
