...
<cfif action is "go">
	...
	<cfset sql="
		...
		from
		    ...
		    inner join coll_object spo on specimen_part.collection_object_id=spo.collection_object_id
		    left outer join  coll_object_remark cir on cataloged_item.collection_object_id=cir.collection_object_id
		    left outer join coll_object_remark spr on  specimen_part.collection_object_id=spr.collection_object_id
		where
