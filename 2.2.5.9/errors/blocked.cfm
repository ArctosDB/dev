	...
	<cfoutput>
		...
		<cfif isSubNetBlock is false>
			<cfquery name="unbl" datasource="uam_god">
			  ...
			  where
			  	status=<cfqueryparam value="active" CFSQLType="CF_SQL_VARCHAR"> and
			...
			<cfsavecontent variable="msg">
				...
				<br><a href="http://whatismyipaddress.com/ip/#session.ipaddress#">[ @whatismyipaddress ]</a>
				<br><a href="https://www.ipalyzer.com/#session.ipaddress#">[ @ipalyzer ]</a>
				<br><a href="https://gwhois.org/#session.ipaddress#">[ @gwhois ]</a>
				<p>
					<a href="#Application.serverRootURL#/Admin/blocklist.cfm?ipstartswith=#session.ipaddress#">[ manage IP and subnet restrictions ]</a>
				</p>
				<p>
					email: #email#
				</p>
