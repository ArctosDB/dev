...
alter table cf_dataentry_settings add column georeference_protocol smallint default 2;
alter table cf_dataentry_settings add column georeference_source smallint default 2;

georeference_protocol,georeference_source
---->
...
<cfoutput>
	<cfif action is "nothing">
		...
		<cfset coordinates="ORIG_LAT_LONG_UNITS,DEC_LAT,DEC_LONG,LATDEG,DEC_LAT_MIN,LATMIN,LATSEC,LATDIR,LONGDEG,DEC_LONG_MIN,LONGMIN,LONGSEC,LONGDIR,DATUM,LAT_LONG_REF_SOURCE,MAX_ERROR_DISTANCE,MAX_ERROR_UNITS,GEOREFMETHOD,VERIFICATIONSTATUS,UTM_ZONE,UTM_EW,UTM_NS,GEOREFERENCE_PROTOCOL,GEOREFERENCE_SOURCE">
		...
		<cfset specimen="FLAGS,COLL_OBJ_DISPOSITION,CONDITION,COLL_OBJECT_REMARKS,DISPOSITION_REMARKS,RELATIONSHIP,RELATED_TO_NUMBER,RELATED_TO_NUM_TYPE,CATALOGED_ITEM_TYPE">
		...
		<cfset locatts="LOCALITY_ATTRIBUTE_TYPE_1,LOCALITY_ATTRIBUTE_VALUE_1,LOCALITY_ATTRIBUTE_UNITS_1,LOCALITY_ATTRIBUTE_REMARK_1,LOCALITY_ATTRIBUTE_DETERMINER_1,LOCALITY_ATTRIBUTE_DETR_METH_1,LOCALITY_ATTRIBUTE_DETR_DATE_1,LOCALITY_ATTRIBUTE_TYPE_2,LOCALITY_ATTRIBUTE_VALUE_2,LOCALITY_ATTRIBUTE_UNITS_2,LOCALITY_ATTRIBUTE_REMARK_2,LOCALITY_ATTRIBUTE_DETERMINER_2,LOCALITY_ATTRIBUTE_DETR_METH_2,LOCALITY_ATTRIBUTE_DETR_DATE_2,LOCALITY_ATTRIBUTE_TYPE_3,LOCALITY_ATTRIBUTE_VALUE_3,LOCALITY_ATTRIBUTE_UNITS_3,LOCALITY_ATTRIBUTE_REMARK_3,LOCALITY_ATTRIBUTE_DETERMINER_3,LOCALITY_ATTRIBUTE_DETR_METH_3,LOCALITY_ATTRIBUTE_DETR_DATE_3,LOCALITY_ATTRIBUTE_TYPE_4,LOCALITY_ATTRIBUTE_VALUE_4,LOCALITY_ATTRIBUTE_UNITS_4,LOCALITY_ATTRIBUTE_REMARK_4,LOCALITY_ATTRIBUTE_DETERMINER_4,LOCALITY_ATTRIBUTE_DETR_METH_4,LOCALITY_ATTRIBUTE_DETR_DATE_4,LOCALITY_ATTRIBUTE_TYPE_5,LOCALITY_ATTRIBUTE_VALUE_5,LOCALITY_ATTRIBUTE_UNITS_5,LOCALITY_ATTRIBUTE_REMARK_5,LOCALITY_ATTRIBUTE_DETERMINER_5,LOCALITY_ATTRIBUTE_DETR_METH_5,LOCALITY_ATTRIBUTE_DETR_DATE_5,LOCALITY_ATTRIBUTE_TYPE_6,LOCALITY_ATTRIBUTE_VALUE_6,LOCALITY_ATTRIBUTE_UNITS_6,LOCALITY_ATTRIBUTE_REMARK_6,LOCALITY_ATTRIBUTE_DETERMINER_6,LOCALITY_ATTRIBUTE_DETR_METH_6,LOCALITY_ATTRIBUTE_DETR_DATE_6">
		...
		<div class="fs">
			...
			<ul>
				...
				<li><a href="##locatts">LocalityAttrs</a></li>
		...
		<form name="customize" method="post" action="customizeDataEntry.cfm">
			...
			<a name="locatts" href="##top">[ top ]</a>
			<span class="likeLink" onclick="customize.submit();">[ save and close ]</span>
			<div class="fs" id="locatts">
				<!--- geol ---->
				<strong>LocalityAttrs</strong>
				<br>
				<span class="likeLink" onclick="toggleTo('locatts','0')">[ hide all ]</span>
				<span class="likeLink" onclick="toggleTo('locatts','1')">[ show all ]</span>
				<span class="likeLink" onclick="toggleTo('locatts','2')">[ carry all ]</span>
				<table border>
					<cfloop list="#locatts#" index="i">
						<tr>
							<td>
								<div <cfif listfindnocase(child,i)>class="child"</cfif>>#i#</div>
							</td>
