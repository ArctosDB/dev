...
<cffunction name="getPublicationCitations"  access="remote">
	...
	<cfoutput>
		<cfquery name="c" datasource="uam_god">
			select * from cache_publication_sdata where source='opencitations' and doi='#doi#' and last_date > now() - interval '30 days'
		</cfquery>
		...
		<cfelse>
			...
			<cfif left(jmc.Statuscode,3) is not "200" or len(jmc.Filecontent) is 0>
				<cfreturn "Invalid return for https://doi.org/#doi#">
			</cfif>
			...
			<cfquery name="uc" datasource="uam_god">
				insert into cache_publication_sdata (doi,json_data,jmamm_citation,source,last_date) values
				 ('#doi#', <cfqueryparam value="#d.Filecontent#" cfsqltype="cf_sql_varchar">,'#jmc.fileContent#','opencitations',current_date)
			</cfquery>
		...
		<cfsavecontent variable="r">
			...
			<cfloop array="#x#" index="idx">
				...
				<cfif StructKeyExists(idx, "citing")>
					...
					<cfquery name="c" datasource="uam_god">
						select * from cache_publication_sdata where source='crossref' and doi='#cdoi#' and last_date > now() - interval '30 days'
					</cfquery>
					<cfif c.recordcount gt 0>
						<cfset tr=DeserializeJSON(c.json_data)>
						<cfset jmamm_citation=c.jmamm_citation>
					<cfelse>
						<cfhttp result="d" method="get" url="https://api.crossref.org/v1/works/https://doi.org/#cdoi#">
							<cfhttpparam type = "header" name = "User-Agent" value = "Arctos (https://arctos.database.museum; mailto:dustymc@gmail.com)">
						</cfhttp>
						<cfhttp result="jmc" method="get" url="https://doi.org/#cdoi#">
							<cfhttpparam type = "header" name = "User-Agent" value = "Arctos (https://arctos.database.museum; mailto:dustymc@gmail.com)">
							<cfhttpparam type = "header" name = "Accept" value = "text/bibliography; style=journal-of-mammalogy">
						</cfhttp>
						...
						<cfelse>
							<cfset jmamm_citation='lookup failure: https://doi.org/#cdoi#'>
						</cfif>

						<cfif not isjson(d.Filecontent)>
							<cfreturn "lookup failure for https://api.crossref.org/v1/works/https://doi.org/#cdoi#">
						</cfif>
						<cfquery name="dc" datasource="uam_god">
						...
						<cfquery name="uc" datasource="uam_god">
							insert into cache_publication_sdata (doi,json_data,source,jmamm_citation,last_date) values
							 ('#cdoi#', <cfqueryparam value="#d.Filecontent#" cfsqltype="cf_sql_varchar">,'crossref','#jmamm_citation#',current_date)
						</cfquery>
						<!----
						this isn't used
					...
					<div class="refDiv">
						#jmamm_citation#
						<br><a class="external" target="_blank" href="https://doi.org/#cdoi#">https://doi.org/#cdoi#</a>
						<br><a target="_blank" class="external" href="https://api.crossref.org/v1/works/https://doi.org/#cdoi#">view raw data</a>
	...
	<cfoutput>
		...
		<cfelse>
			...
			<cfif left(d.statuscode,3) is not "200" or not isjson(d.Filecontent)>
				<cfreturn "Lookup failed at https://api.crossref.org/v1/works/https://doi.org/#doi#">
			</cfif>
			<cfif left(jmc.statuscode,3) is "200">
				<cfset jmcdata=jmc.fileContent>
			<cfelse>
				<cfset jmcdata='Lookup failed at https://doi.org/#doi# with #jmc.statuscode#'>
			</cfif>
			<cfquery name="dc" datasource="uam_god">
		...
		<cfsavecontent variable="r">
			...
			<cfloop array="#x.message.reference#" index="idx">
				...
				<cfif StructKeyExists(idx, "doi")>
					...
					<cfquery name="c" datasource="uam_god">
						select * from cache_publication_sdata where source='crossref' and doi='#thisDOI#' and last_date >  now() - interval '30 days'
					</cfquery>
					<cfif c.recordcount gt 0>
						<cfset rfs=c.jmamm_citation>
					<cfelse>
						<cfhttp result="d" method="get" url="https://api.crossref.org/v1/works/https://doi.org/#thisDOI#">
							<cfhttpparam type = "header" name = "User-Agent" value = "Arctos (https://arctos.database.museum; mailto:dustymc@gmail.com)">
						</cfhttp>
						<cfhttp result="jmc" method="get" url="https://doi.org/#thisDOI#">
							<cfhttpparam type = "header" name = "User-Agent" value = "Arctos (https://arctos.database.museum; mailto:dustymc@gmail.com)">
							<cfhttpparam type = "header" name = "Accept" value = "text/bibliography; style=journal-of-mammalogy">
						</cfhttp>
						<cfif not isjson(d.Filecontent) or left(d.statuscode,3) is not "200" or left(jmc.statuscode,3) is not "200">
							<cfset rfs="invalid return; https://api.crossref.org/v1/works/https://doi.org/#thisDOI# and / or https://doi.org/#thisDOI# did not resolve (possibly not a valid DOI?)">
						<cfelse>
							<cfquery name="dc" datasource="uam_god">
							...
							<cfquery name="uc" datasource="uam_god">
								insert into cache_publication_sdata (doi,json_data,jmamm_citation,source,last_date) values
								 ('#thisDOI#', <cfqueryparam value="#d.Filecontent#" cfsqltype="cf_sql_varchar">,'#jmc.fileContent#','crossref',current_date)
							</cfquery>
				...
				<div class="refDiv">
					#rfs#
					 <cfif StructKeyExists(idx, "doi")>
						 <cfset thisDOI=idx["doi"]>
						<br><a class="external" target="_blank" href="https://doi.org/#thisDOI#">https://doi.org/#thisDOI#</a>
						<br><a href="publicationDetails.cfm?doi=#thisDOI#">[ more information ]</a>
						<br><a target="_blank" class="external" href="https://api.crossref.org/v1/works/https://doi.org/#thisDOI#">view raw data</a>
...
<cffunction name="getCrossrefPublication"  access="remote">
	...
	<cfoutput>
		<cfsavecontent variable="r">
			<p>
				<a target="_blank" class="external" href="https://api.crossref.org/v1/works/https://doi.org/#doi#">view data</a>
			</p>
		...
		<cfelse>
			...
			<cfif left(jmc.statuscode,3) is "200">
				<cfset jmcdata=jmc.fileContent>
			<cfelse>
				<cfset jmcdata='lookup of https://doi.org/#doi# failed with #jmc.statuscode#'>
			</cfif>
			<cfquery name="dc" datasource="uam_god">
				delete from cache_publication_sdata where source='crossref' and doi='#doi#'
			</cfquery>
			...
			<cfloop array="#fd#" index="fdrs">
				<li>
					...
					<cfif structKeyExists(fdrs,"DOI")>
						(<a href="https://doi.org/#fdrs["DOI"]#" target="_blank" class="external">#fdrs["DOI"]#</a>)
					</cfif>
...
<cffunction name="loadFileS3" output="false" returnType="any" access="remote">
	...
	<cftry>
		...
		<!--- lucee sucks at thumbnails
			see https://github.com/ArctosDB/arctos/issues/2485
