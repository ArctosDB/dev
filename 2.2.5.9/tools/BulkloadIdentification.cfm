...
-- sensu_publication_id and taxon_concept_id are varchar because the loader is wonky with NULL (they usually are) numerics
drop table cf_temp_identification;
...
create table cf_temp_identification (
	...
	nature_of_id varchar(30),
	accepted_fg int check (accepted_fg in (0,1)),
	identification_remarks varchar(4000),
	identification_confidence varchar(255),
...
<!------------------------------ BEGIN: access. ----------------------------------------->
<!---
	This should generally be manage_collection plus any "specialty roles."
	The taxonomy bulkloader should be "manage_collection,manage_taxonomy" for example.
--->
...
<cfoutput>
	...
	<cfset thisFormFile="BulkloadIdentification.cfm">
	<cfset thisFormName="Bulkload Identification">
	<cfset thisFormPurpose='This tool allows Arctos operators with <a href="/Admin/user_roles.cfm">role(s)</a> (#required_roles#) to create and review Identification'>
	<cfset thisTable="cf_temp_identification">
	<cfset thisTemplateName="bulkloadIdentification.csv">
	<cfset thisDownloadName="bulkloadIdentificationData.csv">
	<cfset templateHeader="guid,guid_prefix,other_id_type,other_id_number,scientific_name,made_date,nature_of_id,accepted_fg,identification_remarks,identification_confidence,sensu_publication_id,sensu_publication_title,taxon_concept_id,taxon_concept_label,agent_1,agent_2,agent_3,agent_4,agent_5,agent_6">
...
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>conditionally</td>
		<td>
			guid, or (guid_prefix,other_id_type,other_id_number), or (other_id_type,other_id_number) must be provided and must resolve to a single catalog record.
			Example: UAM:Mamm:1234
		</td>
	</tr>
	<tr>
		<td>guid_prefix</td>
			...
			<form name="f" method="post" action="#thisFormFile#">
				...
				<table border id="t" class="sortable">
					<tr>
						...
						<th>sensu_publication_id</th>
						<th>sensu_publication_title</th>
						<th>taxon_concept_id</th>
						<th>taxon_concept_label</th>
						<th>agent_1</th>
						<th>agent_2</th>
						<th>agent_3</th>
						<th>agent_4</th>
