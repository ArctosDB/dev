...
<!----
create table cf_temp_media_labels_ldr (
	key serial not null,
	media_id bigint not null,
	media_label varchar not null,
...
grant select,insert,update,delete on cf_temp_media_labels_ldr to manage_collection;

grant select, usage on cf_temp_media_labels_ldr_key_seq to public;


--alter table cf_temp_media_labels_ldr rename column higher_geography to higher_geog;
...
<cfset required_roles="manage_media">
<cfoutput>
	...
	<cfset title="Bulkload Media Labels">
	<cfset thisFormFile="bulkloadMediaLabels.cfm">
	<cfset thisFormName="Bulkload Media Labels Tool">
	<cfset thisFormPurpose='This tool allows Arctos operators with <a href="/Admin/user_roles.cfm">role(s)</a> (#required_roles#) to create and review Media Labels.'>
	<cfset thisTable="cf_temp_media_labels_ldr">
	<cfset thisTemplateName="bulkloadMediaLabels.csv">
	<cfset thisDownloadName="bulkloadMediaLabelsData.csv">
	<cfset templateHeader="media_id,media_label,label_value">
</cfoutput>
...
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>yes</td>
		<td>
			ID of existing Media record; 10225172 from https://arctos.database.museum/media/10225172
		</td>
	</tr>
	<tr>
		<td>media_label</td>
		<td>yes</td>
		<td>
			https://arctos.database.museum/info/ctDocumentation.cfm?table=ctmedia_label
		</td>
	</tr>
	<tr>
		<td>label_value</td>
