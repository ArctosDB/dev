...
create table cf_temp_specevent (
	...
	habitat varchar(255),
	specimen_event_remark varchar(255),
	...
	georeference_source varchar(255),
...
<cfoutput>
	...
	<cfset title="Bulkload Specimen Event">
	<cfset thisFormFile="BulkloadSpecimenEvent.cfm">
	<cfset thisFormName="Bulkload Specimen Event Tool">
	<cfset thisFormPurpose='This tool allows Arctos operators with <a href="/Admin/user_roles.cfm">role(s)</a> (#required_roles#) to create and review demo-things.'>
	<cfset thisTable="cf_temp_specevent">
	<cfset thisTemplateName="bulkloadSpecimenEventTemplate.csv">
	<cfset thisDownloadName="bulkloadSpecimenEventData.csv">
	<cfset templateHeader="guid,uuid,specimen_event_type,assigned_by_agent,assigned_date,verificationstatus,verified_by_agent,verified_date,collecting_method,collecting_source,habitat,specimen_event_remark,collecting_event_id,collecting_event_name,verbatim_date,verbatim_locality,coll_event_remarks,began_date,ended_date,orig_lat_long_units,datum,max_error_distance,max_error_units,georeference_source,georeference_protocol,dec_lat,dec_long,latdeg,latmin,latsec,latdir,longdeg,longmin,longsec,longdir,dec_lat_deg,dec_lat_min,dec_lat_dir,dec_long_deg,dec_long_min,dec_long_dir,utm_zone,utm_ew,utm_ns,locality_name,locality_id,spec_locality,minimum_elevation,maximum_elevation,orig_elev_units,min_depth,max_depth,depth_units,locality_remarks,geog_auth_rec_id,higher_geog">
		...
		<cfquery name="d" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
	        select * from #thisTable# where 1=1
				...
				<cfif isdefined("uuid") and len(uuid) gt 0>
					...
					and uuid=<cfqueryparam value="#UUID#" CFSQLType="CF_SQL_varchar" list="false">					
