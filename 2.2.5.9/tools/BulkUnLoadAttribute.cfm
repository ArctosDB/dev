...
<cfset title="Un-Bulkload Attributes">
<cfset thisFormFile="BulkUnLoadAttribute.cfm">
<cfset thisFormName="Bulk Unload Attributes Tool">
<cfset thisFormPurpose='This tool allows Arctos operators with the <a href="/Admin/user_roles.cfm">Manage Collection</a> role to DELETE Attributes.
	This process is irreversible; proceed with great caution. This form will unload ALL Attributes of a type for a catalog record.
	A record may have multiple attributes of a type (eg, sex determinations), this will permanently remove them all.'>
<cfset thisTable="cf_temp_unload_attribute">
<cfset thisTemplateName="bulkloadUnloadAttributeTemplate.csv">
<cfset thisDownloadName="bulkloadUnloadAttributeData.csv">
	...
	<cfoutput>
		...
		<table border>
			...
			<tr>
				...
				<td>yes</td>
				<td>
					DWC Triplet GUID of the record from which to remove attributes. Note that all attribute of the specified type are removed; this form has no finer filters.
				</td>
			</tr><tr>
				<td>attribute</td>
				<td>yes</td>
