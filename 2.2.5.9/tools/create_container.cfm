...
<cfoutput>
	...
	<cfset title="Bulkload Containers">
	<cfset thisFormFile="create_container.cfm">
	<cfset thisFormName="Bulkload Container Tool">
	<cfset thisFormPurpose='This tool allows Arctos operators with <a href="/Admin/user_roles.cfm">role(s)</a> (#required_roles#) to create and review containers.'>
	<cfset thisTable="cf_temp_container_create">
	<cfset thisTemplateName="create_container.csv">
	<cfset thisDownloadName="create_container_data.csv">
	<cfset templateHeader="container_type,barcode,label,description,container_remarks,width,height,length,institution_acronym,number_rows,number_columns,orientation,positions_hold_container_type">
...
<cfsavecontent variable = "defDocTableGuts">
	...
	<tr>
		...
		<td>conditionally</td>
		<td>
			decimal; (width,height,length) must be given together or not at all	
		</td>
	</tr>
	<tr>
		<td>height</td>
