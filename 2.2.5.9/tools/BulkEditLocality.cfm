...
<cfoutput>
	...
	<cfset templateHeader="locality_name,higher_geog,spec_locality,dec_lat,dec_long,minimum_elevation,maximum_elevation,orig_elev_units,min_depth,max_depth,depth_units,max_error_distance,max_error_units,datum,locality_remarks,georeference_source,georeference_protocol,utm_zone,utm_ew,utm_ns,use_geography_polygon">
</cfoutput>
...
<cfsavecontent variable = "defDocTableGuts">
	...
	<tr>
		...
		<td>
			...
			<ul>
				<li>
					true: Ignore coordinates, use the geography record's polygon. georeference_source and georeference_protocol are required, all other spatial fields are ignored
				</li>
				<li>
