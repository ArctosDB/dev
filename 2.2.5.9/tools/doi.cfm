		...
		<cfif cfhttp.Statuscode is "201 CREATED">
			...
			<cfif columname is "publication_id">
				...
				<cfquery name="inspub" datasource="uam_god">
					update publication set datacite_doi=<cfqueryparam value = "#newDOI#" CFSQLType="CF_SQL_VARCHAR"> where publication_id=<cfqueryparam value = "#pkeyval#" CFSQLType="cf_sql_int">
				</cfquery>
				<p>
