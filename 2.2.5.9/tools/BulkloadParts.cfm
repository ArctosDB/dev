...
<cfset templateHeader="guid,guid_prefix,other_id_type,other_id_number,part_name,condition,disposition,lot_count,remarks,container_barcode,parent_part_barcode,parent_part_name">
...
<cfsavecontent variable = "defDocTableGuts">
			...
			<tr>
				<td>disposition</td>
				<td>yes</td>
				<td>part disposition; <a href="/info/ctDocumentation.cfm?table=CTCOLL_OBJ_DISP">CTCOLL_OBJ_DISP</a></td>
			</tr>
			<tr>
				<td>lot_count</td>
				<td>yes</td>
