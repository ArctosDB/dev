...
<cfoutput>
	...
	<cfif not Argon2CheckHash(pw, exPw.password, 'argon2id')>
		<div class="error">
...
<cfif action is "nothing">
	...
	<cfquery name="OtherIdType" datasource="cf_codetables" cachedwithin="#createtimespan(0,0,60,0)#">
...
<cfif action is "saveSettings">
	<cfquery name="isUser" datasource="cf_dbuser">
		update cf_users set
			block_suggest=<cfqueryparam value='#block_suggest#' CFSQLType="cf_sql_int">
