...
<cfif action is "ajaxGrid">
	...
	<cfoutput>
		<cfset reqdFlds="collection_object_id,status,enteredby">
			...
			$(document).ready(function() {
	    	    ...
	    	    fields: [
					<cfloop list="#usrColumnList#" index="col">
						<cfif col is "enteredby" or col is "guid_prefix"  or col is "enteredtobulkdate">
	...
	<cfif action is "spaceStripper">
		<cfstoredproc datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#" procedure="bulk_stage_junkstripper">
		</cfstoredproc>
	...
	<cfif action is "nothing">
		<cfoutput>
			...
			<p>
				The <a href="/Bulkloader/pre_bulkloader.cfm" class="external">pre-bulkloader</a> will work better for larger problems.
				You may <a href="BulkloadSpecimens.cfm?action=preBulkloader" target="_self">push to pre-bulkloader</a>
			</p>
			<p>
