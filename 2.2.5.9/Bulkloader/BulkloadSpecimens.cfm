...
<cfif action is "nothing">
	...
	<p>
		<a href="http://handbook.arctosdb.org/documentation/bulkloader.html">[ Documentation ]</a> includes field definitions
	</p>
...
<cfoutput>
	<cfquery name="there" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
...
<cfoutput>
	<cfstoredproc datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#" procedure="bulkloader_stage_check">
	</cfstoredproc>
