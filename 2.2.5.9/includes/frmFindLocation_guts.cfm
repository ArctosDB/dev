...
<cfoutput>
	...
	<cfparam name="valid_catalog_term_fg" default="">
	...
	<div class="pglayout">
		...
		<div class="schitem noshow" id="sd_geowkt">
			<label for="hasGeoWKT" title="Geography which does not have associated spatial data is ambiguous and should be avoided.">Has Spatial Geography?</label>
			<select name="hasGeoWKT" id="hasGeoWKT">
				<option value="">[ Geography has spatial representation ]</option>
		...
		<div class="schitem noshow" id="sd_valid_catalog_term_fg">
			<label for="valid_catalog_term_fg" title="Assertable geography may be used in localities.">Assertable Geography?</label>
			<select name="valid_catalog_term_fg" id="valid_catalog_term_fg">
				<option value="">[ Assertable Geography ]</option>
		...
		<div class="schitem noshow" id="sd_continent_ocean">
			<label for="continent_ocean">Continent or Ocean (NULL for null, prefix with = for exact)</label>
			<input type="text" name="continent_ocean" id="continent_ocean" size="50" value="#continent_ocean#" placeholder="Continent or Ocean">
		</div>
	...
	<div>
		...
		<cfif len(session.username) gt 0>
			<input type="button" value="Customize Search" class="cstmBtn" onclick="customizePlaceSearchForm('#srchType#');">
		</cfif>
	</div>
</cfoutput>