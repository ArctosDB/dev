				...
				<div class="nav_menu_item hdr_dropdown">
					<div class="drop_menu_label">
						...
						<div class="drop_list nav_menu_drop">
							<ul>
								<li><a target="_top" href="/home.cfm">Browse Collections</a></li>
								<li><a target="_top" href="/search.cfm">Find Catalog Records</a></li>
								<li><a target="_top" href="/SpecimenUsage.cfm">Find Publications/Projects</a></li>
								<li><a target="_top" href="/taxonomy.cfm">Taxonomy</a></li>
				                <li><a target="_top" href="/MediaSearch.cfm">Media/Documents</a></li>
				                <li><a target="_top" href="/place.cfm?sch=geog">Geography</a></li>
				                <li><a target="_top" href="/place.cfm?sch=locality">Locality</a></li>
				                <li><a target="_top" href="/place.cfm?sch=collecting_event">Event</a></li>
				                <li><a target="_top" href="/info/ctDocumentation.cfm">Explore Code&nbsp;Tables</a></li>
								<li><a target="_top" href="/agent.cfm">Agents</a></li>
								<li><a target="_top" href="/info/api.cfm">API</a></li>
								<li><a target="_top" href="/random.cfm">Randomizer</a></li>
							</ul>
						</div>
					</div>
				</div>
