...
<cfoutput>
	...
	<cfelse>
		...
		<a target="_blank" href="/search.cfm?oidoper=IS&oidtype=Organism%20ID&oidnum=#application.serverRootURL#/guid/#guid#"><input type="button" value="See Components in Results"></a>
		</h4>
