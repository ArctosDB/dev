...
function ssNoCon(){
	$('#identification_confidence').val('use_existing_conf');
}
...
function addIdentifier(identification_id,num) {
	...
	var onchgStr = "pickAgentModal('IdBy_"  + identification_id + "_" + num + '_id' + "','IdBy_" + identification_id + "_" + num + "',this.value); return false;";
