...
<cfloop query="d">
    ...
    <cfif len(orig_elev_units) gt 0>
	    <cfquery name="ctorig_elev_units" datasource="uam_god"  cachedwithin="#createtimespan(0,0,60,0)#">
			select count(*) c from ctlength_units where length_units=<cfqueryparam value="#d.orig_elev_units#" CFSQLType="CF_SQL_VARCHAR">
	    </cfquery>
	    <cfif ctorig_elev_units.recordcount neq 1>
		...
		<cftransaction>
			<cfquery name="uploc" datasource="uam_god">
				update locality set
					...
					georeference_source=<cfqueryparam value="#d.georeference_source#" CFSQLType="CF_SQL_VARCHAR" null="#Not Len(Trim(d.georeference_source))#">,
