	...
	<cfoutput>
		<cfquery name="l" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
	   		select
				...
				ST_AsText(geog_auth_rec.spatial_footprint) as geo_footprint,
		...
		<form name="editForkSpecEvent" id="editForkSpecEvent" method="post" action="specLocality_forkLocStk.cfm">
			...
			<!----
				...
				---->
				<input type="hidden" id="geopoly" value="#l.geo_footprint#">
				...
				<tr>
					<td><!--- main cell --->
								...
								<tr>
									<td>
										<fieldset id="fs_spatial">
											...
											<input  type="number" step="any" name="wkt_media_id"  id="wkt_media_id" value="#locDet.wkt_media_id#" size="10">
											---->
						...
						<div id="sspatialmetadiv">
							...
							<input type="text" name="georeference_source" id="georeference_source" size="120" value='#encodeforhtml(l.georeference_source)#' />
							<table>
								<tr>
									<td>
							...
							<tr>
								...
								<td>
									...
									<select name="max_error_units" id="max_error_units" size="1">
										<option value=""></option>
										<cfloop query="ctlength_units">
											<option <cfif l.max_error_units is ctlength_units.length_units> selected="selected" </cfif>
					...
					<td width="40%" valign="bottom"><!--- maptools cell --->
						<div id="maptools">
							...
							<br>
								...
								+/-<input type="text" id="s_dollar_error_meters" value="#l.s$error_meters#" size="6">m
		...
		<cftransaction>
			...
			<cfquery name="mkloc" datasource="uam_god">
				insert into locality (
	   	 			...
	   	 			<cfqueryparam value="#DEC_LAT#" CFSQLType="CF_SQL_NUMERIC">,
	   	 			<cfqueryparam value="#DEC_LONG#" CFSQLType="CF_SQL_NUMERIC">,
