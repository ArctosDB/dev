		...
		<cfset number_positions=NUMBER_ROWS * NUMBER_COLUMNS>
			...
			<cfloop from="1" to="#number_positions#" index="i">
				<cfstoredproc procedure="createContainer" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
					...
					<cfprocparam cfsqltype="cf_sql_varchar" value="#i#"  null="#Not Len(Trim(i))#"><!---- v_label --->
					<cfprocparam cfsqltype="cf_sql_varchar" value="" null="true"><!---- v_description ---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="" null="true"><!---- v_container_remarks ---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="" null="true"><!---- v_barcode ---->
					...
					<cfprocparam cfsqltype="cf_sql_int" value="" null="true"><!---- v_number_rows ---->
					<cfprocparam cfsqltype="cf_sql_int" value="" null="true"><!---- v_number_columns ---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="" null="true"><!---- v_orientation ---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="" null="true"><!---- v_posn_hld_ctr_typ ---->
					...
					<cfprocparam cfsqltype="cf_sql_int" value="#container_id#"  null="#Not Len(Trim(container_id))#"><!---- v_parent_container_id ---->
				</cfstoredproc>
			</cfloop>
		</cftransaction>
