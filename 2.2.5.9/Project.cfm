...
<cfif action is "editProject">
	...
	<cfoutput>
		...
		<cfquery name="agents" dbtype="query">
			...
			group by project_agent_id,agent_name, agent_position, agent_id, project_agent_role,project_agent_remarks,award_number,join_date,leave_date
			order by agent_position,agent_name
		</cfquery>
		...
		<cfif len(doi.doi) gt 0>
			DOI: <a class="external" href="https://doi.org/#doi.doi#">https://doi.org/#doi.doi#</a>
		<cfelse>
