...
<cfif action is "update">
	<cfoutput>
		...
		<!----
			keep this around its handy for debugging
			<p>
				select updateContainer (
					#container_id#,
					#parent_container_id#,
					'#container_type#',
					'#label#',
			...
			<cfstoredproc procedure="updateContainer" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
				<cfprocparam cfsqltype="cf_sql_int" value="#container_id#"><!---- v_container_id ---->
				<cfprocparam cfsqltype="cf_sql_int" value="#parent_container_id#" null="#Not Len(Trim(parent_container_id))#"><!---- v_parent_container_id ---->
				<cfprocparam cfsqltype="cf_sql_varchar" value="#container_type#" null="#Not Len(Trim(container_type))#"><!---- v_container_type ---->
				<cfprocparam cfsqltype="cf_sql_varchar" value="#label#" null="#Not Len(Trim(label))#"><!---- v_label ---->
				<cfprocparam cfsqltype="cf_sql_varchar" value="#description#" null="#Not Len(Trim(description))#"><!---- v_description ---->
				<cfprocparam cfsqltype="cf_sql_varchar" value="#container_remarks#" null="#Not Len(Trim(container_remarks))#"><!---- v_container_remarks ---->
				<cfprocparam cfsqltype="cf_sql_varchar" value="#barcode#" null="#Not Len(Trim(barcode))#"><!---- v_barcode ---->
				<cfprocparam cfsqltype="CF_SQL_DOUBLE" value="#width#" null="#Not Len(Trim(width))#"><!---- v_width ---->
				<cfprocparam cfsqltype="CF_SQL_DOUBLE" value="#height#" null="#Not Len(Trim(height))#"><!---- v_height ---->
				<cfprocparam cfsqltype="CF_SQL_DOUBLE" value="#length#" null="#Not Len(Trim(length))#"><!---- v_length ---->
				<cfprocparam cfsqltype="cf_sql_int" value="#number_rows#" null="#Not Len(Trim(number_rows))#"><!---- v_number_rows ---->
     			<cfprocparam cfsqltype="cf_sql_int" value="#number_columns#" null="#Not Len(Trim(number_columns))#"><!---- v_number_columns ---->
     			<cfprocparam cfsqltype="cf_sql_varchar" value="#orientation#" null="#Not Len(Trim(orientation))#"><!---- v_orientation ---->
     			<cfprocparam cfsqltype="cf_sql_varchar" value="#positions_hold_container_type#" null="#Not Len(Trim(positions_hold_container_type))#"><!---- v_posn_hld_ctr_typ ---->
				<cfprocparam cfsqltype="cf_sql_varchar" value="#institution_acronym#" null="#Not Len(Trim(institution_acronym))#"><!---- v_institution_acronym ---->
			</cfstoredproc>
		</cftransaction>
...
<cfif action is "CreateNew">
	<cfoutput>
		<cftransaction>
			<cfstoredproc procedure="createContainer" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
				...
				<cfprocparam cfsqltype="cf_sql_varchar" value="#container_remarks#" null="#Not Len(Trim(container_remarks))#"><!---- v_container_remarks --->
				<cfprocparam cfsqltype="cf_sql_varchar" value="#barcode#" null="#Not Len(Trim(barcode))#"><!---- v_barcode --->
				<cfprocparam cfsqltype="cf_sql_int" value="#width#" null="#Not Len(Trim(width))#"><!---- v_width --->
				<cfprocparam cfsqltype="cf_sql_int" value="#height#" null="#Not Len(Trim(height))#"><!---- v_height --->
				<cfprocparam cfsqltype="cf_sql_int" value="#length#" null="#Not Len(Trim(length))#"><!---- v_length --->
				<cfprocparam cfsqltype="cf_sql_int" value="#number_rows#" null="#Not Len(Trim(number_rows))#"><!---- v_number_rows --->
				<cfprocparam cfsqltype="cf_sql_int" value="#number_columns#" null="#Not Len(Trim(number_columns))#"><!---- v_number_columns --->
				<cfprocparam cfsqltype="cf_sql_varchar" value="#orientation#" null="#Not Len(Trim(orientation))#"><!---- v_orientation --->
				<cfprocparam cfsqltype="cf_sql_varchar" value="#positions_hold_container_type#" null="#Not Len(Trim(positions_hold_container_type))#"><!---- v_posn_hld_ctr_typ --->
				<cfprocparam cfsqltype="cf_sql_varchar" value="#institution_acronym#" null="#Not Len(Trim(institution_acronym))#"><!---- v_institution_acronym --->
				<cfprocparam cfsqltype="cf_sql_int" value="0"><!---- v_parent_container_id --->
			</cfstoredproc>
