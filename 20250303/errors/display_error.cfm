                ...
                <div style="display: table-cell;vertical-align: top; padding:1em;">
                    ...
                    <cfelse>
                        ...
                        <ol>
                            ...
                            <!---- https://github.com/ArctosDB/arctos/issues/7972 ---->
                            <li>On transaction and other forms, please use your browser's <strong>Back</strong> button to correct and resend your entries.</li>
                        </ol>
                    </cfif>
                </div>
            </div>
