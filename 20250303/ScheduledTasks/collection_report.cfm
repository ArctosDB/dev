...
<cfoutput>
	...
	<cfloop query="colns">
		<cfsavecontent variable="crept">
			...
			<p>
				Details and tools are available in the manage collection application,
				<a href="#Application.serverRootUrl#/Admin/Collection.cfm?guid_prefix=#guid_prefix#">
					#Application.serverRootUrl#/Admin/Collection.cfm?guid_prefix=#guid_prefix#
				</a>
			</p>
			<p>
