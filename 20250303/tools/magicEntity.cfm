...
<cfif action is "nothing">
	<cfoutput>
		...
		<p>
			This tool will not add to an existing Entity. Use any identifier tool for that, or file an Issue including example data.
		</p>
		<p>
	...
	<cfoutput>
		...
		<cfquery name="accn" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
			...
			where 
				...
				trans.collection_id=<cfqueryparam cfsqltype="cf_sql_int" value="#collection_id#">
		</cfquery>
