...
create table cf_temp_accn (
	...
	status varchar,
	guid_prefix varchar not null,
	accn_number varchar not null,
	accn_type varchar not null,
	accn_status  varchar not null,
	nature_of_material varchar not null,
	estimated_count varchar,
	trans_date varchar not null,
	received_date varchar,
	trans_remarks varchar,
	is_public_fg varchar,
	trans_agent_1 varchar,
	trans_agent_role_1 varchar,
	trans_agent_2 varchar,
	trans_agent_role_2 varchar,
	trans_agent_3 varchar,
	trans_agent_role_3 varchar,
	trans_agent_4 varchar,
	trans_agent_role_4 varchar,
	trans_agent_5 varchar,
	trans_agent_role_5 varchar,
	trans_agent_6 varchar,
	trans_agent_role_6 varchar
);

grant select, insert, update, delete on cf_temp_accn to manage_collection;
grant select, usage on cf_temp_accn_key_seq to public;

ALTER TABLE cf_temp_accn ALTER COLUMN received_date DROP NOT NULL;
...
<cfoutput>
	...
	<cfset title="Bulkload Accessions">
	<cfset thisFormFile="BulkloadAccn.cfm">
	<cfset thisFormName="Bulkload Accession Tool">
	<cfset thisFormPurpose='This tool allows Arctos operators with <a href="/Admin/user_roles.cfm">role(s)</a> (#required_roles#) to create and review Accessions.'>
	<cfset thisTable="cf_temp_accn">
	<cfset thisTemplateName="bulkloadAccn.csv">
	<cfset thisDownloadName="bulkloadAccnData.csv">
	<cfset templateHeader="guid_prefix,accn_number,accn_type,accn_status,nature_of_material,estimated_count,trans_date,received_date,trans_remarks,is_public_fg,trans_agent_1,trans_agent_role_1,trans_agent_2,trans_agent_role_2,trans_agent_3,trans_agent_role_3,trans_agent_4,trans_agent_role_4,trans_agent_5,trans_agent_role_5,trans_agent_6,trans_agent_role_6">
</cfoutput>
...
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>yes</td>
		<td>
			collection owning the accession
		</td>
	</tr>
	<tr>
		<td>accn_number</td>
	...
	<tr>
		...
		<td>yes</td>
		<td>
			 <a href="/info/ctDocumentation.cfm?table=ctACCN_TYPE">ctACCN_TYPE</a>
		</td>
	</tr>
	<tr>
		<td>accn_status</td>
		<td>yes</td>
		<td>
			 <a href="/info/ctDocumentation.cfm?table=ctACCN_STATUS">ctACCN_STATUS</a>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>yes</td>
		<td>
			 Can the data be publicly displayed? 0=no, 1=yes
		</td>
	</tr>
	...
	<tr>
		...
		<td>no</td>
		<td>
			 Agent name; must resolve to one Agent
		</td>
	</tr>
	...
	<tr>
		...
		<td>no</td>
		<td>
			 <a href="/info/ctDocumentation.cfm?table=cttrans_agent_role">cttrans_agent_role</a>
		</td>
	</tr>
	<tr>
		<td>status</td>
			...
			<form name="f" method="post" action="#thisFormFile#">
				...
				<table border id="t" class="sortable">
					<tr>
						...
						<th>is_public_fg</th>
						<th>trans_agent_1</th>
						<th>trans_agent_role_1</th>
						<th>trans_agent_2</th>
						<th>trans_agent_role_2</th>
						<th>trans_agent_3</th>
						<th>trans_agent_role_3</th>
						<th>trans_agent_4</th>
						<th>trans_agent_role_4</th>
						<th>trans_agent_5</th>
						<th>trans_agent_role_5</th>
						<th>trans_agent_6</th>
						<th>trans_agent_role_6</th>
						<!--------------- END::this section will need customized for individual loaders ----------------------------->
					</tr>
					<cfloop query="d">
						<tr>
							...
							<td>#is_public_fg#</td>
							<td>#trans_agent_1#</td>
							<td>#trans_agent_role_1#</td>
							<td>#trans_agent_2#</td>
							<td>#trans_agent_role_2#</td>
							<td>#trans_agent_3#</td>
							<td>#trans_agent_role_3#</td>
							<td>#trans_agent_4#</td>
							<td>#trans_agent_role_4#</td>
							<td>#trans_agent_5#</td>
							<td>#trans_agent_role_5#</td>
							<td>#trans_agent_6#</td>
							<td>#trans_agent_role_6#</td>
							<!--------------- END::this section will need customized for individual loaders ----------------------------->
						</tr>
					</cfloop>
				</table>
