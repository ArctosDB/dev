...
<cfif dups.recordcount is 0>
	...
	<p>
		<a href="/place.cfm?sch=collecting_event&locality_id=#locality_id#">return to event list</a>
	</p>
<cfelse>
	...
	<cfloop query="dups">
		...
		<cfif action is "makeMerge">
			<cfquery name="mergeSE" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
				update 
					specimen_event 
				set 
			...
			<cfquery name="mergeMR" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
				update 
					media_relations 
				set 
			...
			<cfquery name="deleteEvents" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
