<!---------
	replace #application.serverRootUrl# with https://arctos.database.museum so this works at test, hope to not regret...
	...
	<cfoutput>
		...
		<cfquery name="rr" datasource="uam_god">
			...
			where 
				...
				display_value=<cfqueryparam value = "https://arctos.database.museum/guid/#cr.guid#" CFSQLType="CF_SQL_varchar"> 
			</cfquery>
