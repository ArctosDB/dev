			...
			<cftry>
				...
				<cfif nct.recordcount gt 0 and ct.recordcount gt 0>
					...
					<cftransaction>
						...
						<cfloop query="nct">
							<cfif len(t) gt 0 and len(v) gt 0>
...
<!--------------------------------------------------------------------------------------->
	<cffunction name="validateName" access="remote">
		...
		<cfoutput>
			...
			<cftry>
				<cfhttp url="https://www.wikidata.org/w/api.php?action=wbsearchentities&search=#taxon_name#&language=en&format=json" method="get" timeout="2"></cfhttp>
			...
			<!----------
			<cfhttp url="http://gni.globalnames.org/api/v1/verifications/#taxon_name#" method="get"  timeout="5">
			</cfhttp>

			<cfif isdefined("debug") and debug is true>
				<p>http://gni.globalnames.org/api/v1/verifications/#taxon_name#</p>
				<cfdump var=#cfhttp#>
			</cfif>
			<cfif isdefined("cfhttp.status_code") and left(cfhttp.status_code,3) is "200">
			...
			<cftry>
				<cfhttp url="http://www.marinespecies.org/rest/AphiaIDByName/#taxon_name#?marine_only=false" method="get"  timeout="2">
				...
				<cfif isdefined("cfhttp.status_code") gt 0 and left(cfhttp.status_code,3) is "200">
			...
			<cftry>
				<cfhttp url="http://eol.org/api/search/1.0.json?page=1&q=/#taxon_name#&exact=true" method="get"  timeout="2">
					<cfhttpparam type="header" name="accept" value="application/json">
				</cfhttp>
				<cfif isdefined("debug") and debug is true>
			...
			<cftry>
				<cfhttp url="http://api.gbif.org/v1/species?strict=true&name=#taxon_name#&nameType=scientific" method="get"  timeout="2">
					<cfhttpparam type="header" name="accept" value="application/json">
				</cfhttp>
			...
			<cftry>
				<cfhttp url="http://zoobank.org/NomenclaturalActs.json/#replace(taxon_name,' ','_')#" method="get"  timeout="2">
					<cfhttpparam type="header" name="accept" value="application/json">
				</cfhttp>
