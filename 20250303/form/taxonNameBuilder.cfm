...
<cfoutput>
	...
	<cfparam name="saveto" default="taxon_name">
	<cfparam name="cb" default="">
	...
	<form name="theForm" id="theForm">
		...
		<input type="hidden" name="saveto" id="saveto" value='#saveto#'>
		<input type="hidden" name="cb" id="cb" value='#encodeforhtml(cb)#'>
