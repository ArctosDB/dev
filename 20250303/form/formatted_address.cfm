...
<cfoutput>
	<p>
		This form helps manage and format addresses as JSON. These are used by the GenBank Packager, EML Generator, and various other components. "Standard" fields are handled;
