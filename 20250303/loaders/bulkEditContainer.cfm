...
drop table cf_temp_edit_container;
...
delete from cf_component_loader where loader_template='autoload_container_edits';
...
insert into cf_component_loader (
	...
	'Bulk Edit Container', -- title
	'Edit many containers with one file.
	<ul>
	...
	'autoload_container_edits', -- this will resolve to /ScheduledTasks/componentLoaderComponents/{what you enter here}.cfm
	'/loaders/bulkEditContainer.cfm', -- this should be /loaders/something.cfm - migration in process
	'cf_temp_edit_container', -- the table used by the loader
	500, -- 10 is a nice number; this should NOT tax the server, and must complete in under a minute
	null,
	'manage_records,manage_container', -- list of roles required to set autoload, delete, etc.
	'manage_container', -- list of roles required to insert data
...
<cfoutput>
	...
	<cfset templateHeader="institution_acronym,barcode,old_container_type,container_type,description,container_remarks,length,width,height,dimension_units,label,number_rows,number_columns,orientation,positions_hold_container_type,weight,weight_units,weight_capacity,weight_capacity_units">
...
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>yes</td>
		<td>
			Existing container's institution_acronym.
		</td>
	</tr><tr>
		<td>barcode</td>
		<td>yes</td>
	...
	<tr>
		...
		<td>no</td>
		<td>
			"0" (no quotes) will update to NULL; blank will be ignored (no updates).  <a href="/info/ctDocumentation.cfm?table=ctlength_units">ctlength_units</a>
		</td>
	</tr>
	<tr>
		<td>number_rows</td>
	...
	<tr>
		...
		<td>no</td>
		<td>
			"0" (no quotes)  will update to NULL; blank will be ignored (no updates). <a href="/info/ctDocumentation.cfm?table=CTCONTAINER_TYPE">CTCONTAINER_TYPE</a>
		</td>
	</tr>
	<tr>
		<td>weight</td>
		<td>conditionally</td>
		<td>
			(weight, weight_units) must be given together. Accepts:
			<ul>
				<li>>0 (any number larger than zero) to update</li>
				<li>blank to ignore</li>
				<li>0 to update to NULL</li>
			</ul>
		</td>
	</tr>
	<tr>
		...
		<td>
			(weight, weight_units) must be given together. Accepts:
			<ul>
				<li><a href="/info/ctdocumentation.cfm?table=ctweight_units">ctweight_units</a> to update</li>
				<li>blank to ignore</li>
				<li>blank (paired with weight=0) to update to NULL</li>
			</ul>
		</td>
	</tr>
	<tr>
		...
		<td>conditionally</td>
		<td>
			(weight_capacity, weight_capacity_units) must be given together. Accepts:
			<ul>
				<li>>0 (any number larger than zero) to update</li>
				<li>blank to ignore</li>
				<li>0 to update to NULL</li>
	...
	<tr>
		...
		<td>
			...
			<ul>
				<li><a href="/info/ctdocumentation.cfm?table=ctweight_units">ctweight_units</a> to update</li>
				<li>blank to ignore</li>
				<li>blank (paired with weight_capacity=0) to update to NULL</li>
			</ul>
		</td>
	</tr>
	<tr>
