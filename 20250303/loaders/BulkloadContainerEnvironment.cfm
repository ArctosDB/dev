...
BulkloadContainerEnvironment




	drop table cf_temp_container_environment;

	create table cf_temp_container_environment (
		key serial not null,
		institution_acronym varchar not null,
		barcode varchar not null,
		checked_by_agent varchar not null,
	...
	grant select, insert, update, delete on cf_temp_container_environment to manage_container;
	grant select, usage on cf_temp_container_environment_key_seq to public;

	



delete from cf_component_loader where loader_template='autoload_container_environment';
...
insert into cf_component_loader (
	...
	'Bulkload Container Environment',
	'Add container environment data',
	1, 
	'autoload_container_environment',
	'/loaders/BulkloadContainerEnvironment.cfm',
	'cf_temp_container_environment',
	10,
	null,
	'manage_container',
	'manage_container',
	'Username has access to a collection in the institution.'
);
...
<cfoutput>
	...
	---->
	<cfset templateHeader="institution_acronym,barcode,checked_by_agent,check_date,parameter_type,parameter_value,remark,status">
</cfoutput>
...
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>yes</td>
		<td>Institution owning the container defined by this+barcode</td>
	</tr>
	<tr>
		<td>barcode</td>
		<td>yes</td>
	...
	<tr>
		<td>check_date</td>
		<td>yes</td>
		<td>DATE (*NOT* ISO8601; give as yyyy-mm-dd)</td>
	</tr>
	<tr>
