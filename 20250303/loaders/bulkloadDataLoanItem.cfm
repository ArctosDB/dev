<!------
	...
	drop table cf_temp_dataloan_add;

	create table cf_temp_dataloan_add (
		key serial not null,
		...
		other_id_issued_by varchar(255),
	...
	grant select, insert, update,delete on cf_temp_dataloan_add to manage_transactions;
	grant select, usage on cf_temp_dataloan_add_key_seq to public;
...
delete from cf_component_loader where loader_template='autoload_dataloan_add';
...
insert into cf_component_loader (
	...
	'Data Loan Item Loader', -- title
	'Add catalog records to loans of type data', -- short description of the purpose
	1, -- run_order is a nonunique integer; 1 is as good at anything
	'autoload_dataloan_add', -- this will resolve to /ScheduledTasks/componentLoaderComponents/{what you enter here}.cfm
	'/loaders/bulkloadDataLoanItem.cfm', -- this should be /loaders/something.cfm - migration in process
	'cf_temp_dataloan_add', -- the table used by the loader
...
<cfoutput>
	...
	<cfset templateHeader="guid,guid_prefix,other_id_type,other_id_number,other_id_issued_by,loan_item_description,loan_item_remarks,loan_item_instructions,loan_guid_prefix,loan_number">
...
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>conditionally</td>
		<td>
			either (guid) or (guid_prefix,other_id_type,other_id_number,other_id_issued_by) must be given
		</td>
	</tr>
	<tr>
		<td>guid_prefix</td>
		...
		<td>
			either (guid) or (guid_prefix,other_id_type,other_id_number,other_id_issued_by) must be given
			Expected: guid_prefix available from <a href="/home.cfm">/home.cfm</a>
		</td>
	</tr>
	<tr>
		<td>other_id_type</td>
		...
		<td>
			either (guid) or (guid_prefix,other_id_type,other_id_number,other_id_issued_by) must be given
			Expected: value from <a href="/info/ctDocumentation.cfm?table=ctcoll_other_id_type">ctcoll_other_id_type</a>, or blank to ignore 
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td>other_id_issued_by</td>
		<td>conditionally</td>
		<td>
			either (guid) or (guid_prefix,other_id_type,other_id_number,other_id_issued_by) must be given
			Expected: agent name (or blank to ignore)
		</td>
	</tr>
	<tr>
		...
		<td>no</td>
		<td>
			Leaving this NULL will result in "{guid} cataloged item" being used as loan item description
		</td>
	</tr>
	<tr>
