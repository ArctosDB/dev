...
<cfoutput>
	...
	<cfset templateHeader="guid,guid_prefix,other_id_type,other_id_number,uuid,agent_name,collector_role,coll_order,collector_remark">
</cfoutput>
...
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>conditionally</td>
		<td>
			guid (or triplet), guid_prefix+other_id_type+other_id_number, or UUID may be used to identify the catalog record
		</td>
	</tr>
	<tr>
		<td>guid_prefix</td>
