<!-------
	...
	delete from cf_component_loader where data_table='cf_temp_obj_encumbrance';
	...
	insert into cf_component_loader (
		...
		'Bulkload Encumbrances', -- title
		'Load records to existing encumbrances.', -- short description of the purpose
		1, -- run_order is a nonunique integer; 1 is as good at anything
		'autoload_encumbrance', -- this will resolve to /ScheduledTasks/componentLoaderComponents/{what you enter here}.cfm
		'/loaders/bulkloadEncumbrances.cfm', -- this should be /loaders/something.cfm - migration in process
		'cf_temp_obj_encumbrance', -- the table used by the loader
...
<cfoutput>
	...
	<cfset templateHeader="guid,encumbrance_id,status">
</cfoutput>
