<!-------What this is and how to use it-------------
	...
	drop table cf_temp_container_to_position;

	create table cf_temp_container_to_position (
		key serial not null,
	...
	grant select, insert, update, delete on cf_temp_container_to_position to manage_container;
	grant select, usage on cf_temp_container_to_position_key_seq to public;

	

delete from cf_component_loader where loader_template='autoload_container_to_position';
...
insert into cf_component_loader (
	...
	'loadContainerToPosition',
	'Move barcoded containers to positions in barcoded containers',
	1, 
	'autoload_container_to_position',
	'/loaders/loadContainerToPosition.cfm',
	'cf_temp_container_to_position', 
	10, 
	null,
	'manage_records,manage_container', 
	'manage_records,manage_container',
	'Username has access to corresponding collection'
);

delete from cf_form_permissions where form_path='/loaders/loadContainerToPosition.cfm';
...
insert into cf_form_permissions(
	...
	'/loaders/loadContainerToPosition.cfm',
	'manage_container',
	'Container Position Loader: Install barcoded objects into positions within barcoded containers',
	'Barcodes & Containers',
	'Container Position Loader'
);
...
<cfoutput>
	...
	<cfset templateHeader="institution_acronym,barcode,parent_barcode,position">
</cfoutput>
...
<cfsavecontent variable = "defDocTableGuts">
	...
	<tr>
		...
		<td>
			institution_acronym of all containers
		</td>
	</tr>
	<tr>
		<td>barcode</td>
		<td>yes</td>
		<td>
			barcode of the container to be installed
		</td>
	</tr>
	<tr>
		...
		<td>yes</td>
		<td>
			parent barcode of the position in which barcode will be installed
		</td>
	</tr>
	<tr>
		<td>position</td>
		<td>yes</td>
		<td>
			position, child of parent_barcode, in which barcode will be installed
		</td>
	</tr>
