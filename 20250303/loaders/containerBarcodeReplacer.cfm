...
delete from cf_component_loader where data_table='cf_temp_barcodeswapper';
...
insert into cf_component_loader (
	...
	'Scary Barcode Swapper', -- title
	'Replace barcodes by destroying a donor container.', -- short description of the purpose
	1, -- run_order is a nonunique integer; 1 is as good at anything
	'autoload_barcode_swapper', -- this will resolve to /ScheduledTasks/componentLoaderComponents/{what you enter here}.cfm
	'/loaders/containerBarcodeReplacer.cfm', -- this should be /loaders/something.cfm - migration in process
	'cf_temp_barcodeswapper', -- the table used by the loader
...
<cfoutput>
	...
	<cfset templateHeader="container_id,label,institution_acronym,replacement_barcode,status">
</cfoutput>
...
<cfsavecontent variable = "defDocTableGuts">
	...
	<tr>
		...
		<td>yes</td>
		<td>
			integer: container_id of the container which is getting a new barcode. "12345678" from "https://arctos.database.museum/EditContainer.cfm?container_id=12345678" Available from many paths in search results and object tracking.  Any existing barcode will be lost. 
		</td>
	</tr>
	<tr>
		<td>label</td>
	...
	<tr>
		...
		<td>yes</td>
		<td>
			institution_acronym of donor, and additional check of the keeper. 
		</td>
	</tr>
	<tr>
