                ...
                <td>
                	<cfif structKeyExists(thisAgent.attributes, "address")>
                		...
                		<table border="1">
                			...
                			<cfloop collection="#ts#" item="key">
	                			<!---------- https://github.com/ArctosDB/arctos/issues/8061 ----------->
		                		<cfset thisExtraClass="noData">
		                		<cfif len(ts[key].begin_date) gt 0>
		                			<cfset thisExtraClass="hasdata">
		                		</cfif>
		                		<cfif len(ts[key].end_date) gt 0>
		                			<cfset thisExtraClass="expired">
		                		</cfif>
		                		<tr>
		                			<cfif thisExtraClass is "hasdata">
	                					<td style="font-size: 2em; background-color: green; text-align:center" title="Has date information, probably valid.">
	                						<i class="fa-solid fa-check"></i>
	                					</td>
	                				<cfelseif thisExtraClass is "expired">
	                					<td style="font-size: 2em; background-color: red; text-align:center" title="Has end date, expired.">
	                						<i class="fa-solid fa-xmark"></i>
	                					</td>
	                				<cfelse>
	                					<td style="font-size: 2em; background-color: yellow; text-align:center" title="No date information, who knows!">
									...
									<td>#ts[key].begin_date#</td>
									<td>#ts[key].end_date#</td>
								</tr>
	                        </cfloop>
	                    </table>
                	</cfif>
