deprecated; see https://github.com/ArctosDB/arctos/issues/3905
<cfabort>
<!--- no security --->
...
<cfif action is "makeLink">
	...
	<cfoutput>
		<cfquery name="cum" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
		...
		<cfquery name="ris" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
