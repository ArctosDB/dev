...
<cfoutput>
	...
	<form name="s" id="taxPikFrm" method="post" action="TaxaPick.cfm">
					...
					<td>
						...
						<cfif name_type neq 'quarantine'>
							...
							<input type="button" class="picBtn" value="select" 
								onclick="useThisOne('#formName#','#taxonIdFld#','#taxonNameFld#','#taxon_name_id#','#thisName#')">
						</cfif>
	...
	<cfelse>
		...
		<cfelseif names.recordcount is 1>
			<script>
				useThisOne('#formName#','#taxonIdFld#','#taxonNameFld#','#names.taxon_name_id#','#names.scientific_name#')
			</script>
		</cfif>
		<cfif isdefined("taxonomy_source") and len(taxonomy_source) gt 0>
			<div style="margin:.6em;">
			...
			<cfloop query="names">
				<tr>
					<td>
						...
						<cfif name_type neq 'quarantine'>
							<input type="button" class="picBtn" value="select" 
								onclick="useThisOne('#formName#','#taxonIdFld#','#taxonNameFld#','#taxon_name_id#','#scientific_name#')">
						</cfif>
						<a target="_tab" href="/name/#scientific_name#"><input type="button" class="lnkBtn" value="details"></a>
					</td>
				</tr>
