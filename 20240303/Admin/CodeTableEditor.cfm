...
<p>
	<a href="/info/ctDocumentation.cfm?forceResetCTMCache=true">Back to table list; force-refresh cache</a>
</p>
...
<cfif action is "editcode_table_meta">
	<cfoutput>
		...
		<h2>Edit Code Table Metadata/Definition</h2>
		<p>
			These data define the shape of code tables and should only be changed with consensus of The Community and technical approval. 
		</p>
		<p>
			Description may contain markdown. HTML is not allowed.
		</p>
		<p>
			<a href="/info/ctchange_log.cfm?tbl=code_table_meta">
				<input type="button" class="lnkBtn" value="changelog">
			</a>
		</p>
		<table border>
			<tr>
...
<cfif action is "edit">
	...
	<cfelseif tbl is "ctpart_attribute_type">
		<cflocation url="CodeTableEditor.cfm?action=editctpartattribute_type&tbl=ctpart_attribute_type" addtoken="false" >
	...
	<cfelseif tbl is "ctmortality_cause" or tbl is "ctlanguage" or tbl is "ctformat">
		<!---
			{datafield}
			description
			search_terms
	...
	<cfelseif tbl is "ctuse_condition">
		<!---
			{datafield}
			description
			issue_url
			documentation_url
		---->
		<cflocation url="CodeTableEditor.cfm?action=editNewFormNoCollectionNoSrchTrmsAttribute&tbl=#tbl#" addtoken="false" >
	<cfelse><!---------------------------- normal CTs --------------->
...
<!-------------------------------------------  ------------------>
<cfif action is "editNewFormNoCollectionNoSrchTrmsAttribute">
	<cfif tbl is "ctuse_condition">
		<cfset fld='use_condition'>
	<cfelse>
		wut<cfabort>
	</cfif>
	<style>
		...
		<table id="partstbl" border="1" class="sortable">
			...
			<tbody>
				<tr id="prow_new" class="newRec">
					<td>
						<form id="pfrm_new" method="post" action="CodeTableEditor.cfm">
							<input type="hidden" name="action" value="insertNewFormNoCollectionNoSrchTrmsAttribute">
							<input type="hidden" name="tbl" value="#tbl#">
							<input type="hidden" name="fld" value="#fld#">
							<input type="text" name="new_value" size="25" class="reqdClr" required>
							<br><input type="submit" class="insBtn" value="Create">
				...
				<cfloop query="q">
					...
					<tr id="prow_#rid#">
						<td>
							<form id="pfrm#rid#" method="post" action="CodeTableEditor.cfm">
								<input type="hidden" name="action" value="updateNewFormNoCollectionNoSrchTrmsAttribute">
								<input type="hidden" name="tbl" value="#tbl#">
								<input type="hidden" name="fld" value="#fld#">
								...
								<div class="prtctsavbtns">
									...
									<div class="prtctsavbtnsright">
										<input type="button" class="delBtn" value="Delete" onclick="pfrm#rid#.action.value='deleteNewFormNoCollectionNoSrchTrmsAttribute';pfrm#rid#.submit();">
									</div>
								</div>
							</form>
						</td>
...
<cfif action is "deleteNewFormNoCollectionNoSrchTrmsAttribute">
	<cfoutput>
		<cfquery name="deleteSpecimenPart" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
			delete from #tbl# where #fld#=<cfqueryparam value="#original_data_value#" cfsqltype="cf_sql_varchar">
		</cfquery>
...
<cfif action is "updateNewFormNoCollectionNoSrchTrmsAttribute">
	<cfoutput>
		<cfif reFind('<[^>]*>', description)>
			<div class="importantNotification">
				Description may not contain HTML.
		...
		<cfset rid=rereplace(new_data_value,"[^A-Za-z0-9]","_","all")>
		<cflocation url="CodeTableEditor.cfm?action=editNewFormNoCollectionNoSrchTrmsAttribute&tbl=#tbl###prow_#rid#" addtoken="false">
	</cfoutput>
</cfif>
<!-------------------------------------------------->
<cfif action is "insertNewFormNoCollectionNoSrchTrmsAttribute">
	<cfoutput>
		<cfif reFind('<[^>]*>', description)>
			<div class="importantNotification">
				Description may not contain HTML.
...
<!------------------------------------------- END now nocollection attributes code block ------------------>
<cfif action is "editctpartattribute_type">
	<style>
		#partstbl tr:nth-child(even) {
		   background-color: #ccc;
		}
	...
	<cfset title="ctpart_attribute_type editor">
	<cfquery name="q" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
		select
			attribute_type,
			description,
	...
	<cfoutput>
		...
		<ul>
			...
			<li>public: boolean, visibility</li>
		</ul>
		<table id="partstbl" border="1" class="sortable">
			<thead>
				<tr>
			...
			<tbody>
				<tr id="prow_new" class="newRec">
					<td>
						<form id="pfrm_new" method="post" action="CodeTableEditor.cfm">
							<input type="hidden" name="action" value="insertctpartattribute_type">
							<input type="hidden" name="tbl" value="#tbl#">
							<input type="text" name="new_value" size="25" class="reqdClr" required>
							<br><input type="submit" class="insBtn" value="Create">
						</form>
					...
					<td>
						<select name="public" size="1" form="pfrm_new">
							<option value="true">true</option>
							<option value="false">false</option>
						</select>
					</td>
				...
				<cfloop query="q">
					...
					<tr id="prow_#rid#">
						<td>
							<form id="pfrm#rid#" method="post" action="CodeTableEditor.cfm">
								<input type="hidden" name="action" value="updatectpartattribute_type">
								<input type="hidden" name="attribute_type" value="#attribute_type#">
								<input type="hidden" name="tbl" value="#tbl#">
								<input type="hidden" name="original_data_value" size="25" value="#EncodeForHTML(canonicalize(attribute_type,true,true))#">
								<div>
								...
								<div class="prtctsavbtns">
									...
									<div class="prtctsavbtnsright">
										<input type="button" class="delBtn" value="Delete" onclick="pfrm#rid#.action.value='deletectpartattribute_type';pfrm#rid#.submit();">
									</div>
								</div>
							</form>
						</td>
						...
						<td>
							<select name="public" size="1" form="pfrm#rid#">
								<option <cfif public is true > selected="selected" </cfif>  value="true">true</option>
								<option <cfif public is false > selected="selected" </cfif>  value="false">false</option>
							</select>
						</td>
					</tr>
				</cfloop>
...
<cfif action is "deletectpartattribute_type">
	<cfoutput>
		<cfquery name="deleteSpecimenPart" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
			delete from ctpart_attribute_type where attribute_type=<cfqueryparam value="#original_data_value#" cfsqltype="cf_sql_varchar">
		</cfquery>
		<cflocation url="CodeTableEditor.cfm?action=editctpartattribute_type&tbl=#tbl#" addtoken="false">
	</cfoutput>
</cfif>
<cfif action is "updatectpartattribute_type">
	...
	<cfoutput>
		...
		<cfquery name="updateARow" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
			update ctpart_attribute_type set 
				attribute_type=<cfqueryparam value="#new_data_value#" cfsqltype="cf_sql_varchar">,
				description=<cfqueryparam value="#description#" cfsqltype="cf_sql_varchar">,
				search_terms=<cfqueryparam value="#sst#" cfsqltype="cf_sql_varchar" null="#Not Len(Trim(sst))#">,
				recommend_for_collection_type=string_to_array(<cfqueryparam value="#srt#" cfsqltype="cf_sql_varchar" null="#Not Len(Trim(srt))#">,','),
		...
		<cfset rid=rereplace(new_data_value,"[^A-Za-z0-9]","_","all")>
		<cflocation url="CodeTableEditor.cfm?action=editctpartattribute_type&tbl=#tbl###prow_#rid#" addtoken="false">
	</cfoutput>
</cfif>
<!-------------------------------------------------->
<cfif action is "insertctpartattribute_type">
	<cfoutput>
		<cfif reFind('<[^>]*>', description)>
			<div class="importantNotification">
				Description may not contain HTML.
		...
		<cfset sst=listSort(sst,'text')>
		<cfquery name="insertSpecimenPart" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
			insert into ctpart_attribute_type (
				attribute_type,
				description,
				search_terms,
				recommend_for_collection_type,
...
<!-------------------------------------------------->
<!------------------------------------------- END ctpartattribute_type code block ------------------>
...
<cfif action is "deleteValue">
	<cfif tbl is "ctcoll_other_id_type">
		<cfquery name="sav" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
			...
			where
				OTHER_ID_TYPE=<cfqueryparam value="#origData#" cfsqltype="cf_sql_varchar">
		</cfquery>
	<cfelse>
		<cfquery name="del" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
			DELETE FROM #tbl#
			where #fld# = <cfqueryparam value="#origData#" cfsqltype="cf_sql_varchar">
			<cfif isdefined("collection_cde") and len(collection_cde) gt 0>
				 AND collection_cde=<cfqueryparam value="#origcollection_cde#" cfsqltype="cf_sql_varchar">
			</cfif>
		</cfquery>
	</cfif>
			...
			<cfelse>
				<cfquery name="u" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
					update
						cttaxon_term
					set
						relative_position=<cfqueryparam value="#listpos#" cfsqltype="cf_sql_int">,
						taxon_term=<cfqueryparam value="#thisVAL#" cfsqltype="cf_sql_varchar">,
						description=<cfqueryparam value="#thisDEF#" cfsqltype="cf_sql_varchar">
					where cttaxon_term_id=<cfqueryparam value="#thisROWID#" cfsqltype="cf_sql_int">
				</cfquery>
			</cfif>
		</cfloop>
		</cfoutput>
...
<cfif action is "editMediaLicense_save">
	<cfquery name="sav" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
		update ctmedia_license set
			...
			description=<cfqueryparam value="#description#" cfsqltype="cf_sql_varchar">,
			uri=<cfqueryparam value="#thisVAL#" cfsqltype="uri">
		where media_license_id=<cfqueryparam value="#media_license_id#" cfsqltype="cf_sql_int">
	</cfquery>
	<cflocation addtoken="false" url="CodeTableEditor.cfm?action=edit&tbl=ctmedia_license">
</cfif>
...
<cfif action is "editCollnTerm_save">
	<cfquery name="sav" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
		update ctcollection_terms set
			...
			description=<cfqueryparam value="#description#" cfsqltype="cf_sql_varchar">,
			uri=<cfqueryparam value="#uri#" cfsqltype="cf_sql_varchar">
		where collection_terms_id=<cfqueryparam value="#collection_terms_id#" cfsqltype="cf_sql_int">
	</cfquery>
	<cflocation addtoken="false" url="CodeTableEditor.cfm?action=edit&tbl=ctcollection_terms">
</cfif>
...
<cfif action is "editEventAttAtt_deleteValue">
	<cfquery name="d" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
		delete from ctcoll_event_att_att where event_attribute_type=<cfqueryparam value="#event_attribute_type#" cfsqltype="cf_sql_varchar">
	</cfquery>
...
<cfif action is "editEventAttAtt_saveEdit">
	<cfquery name="d" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
		...
		unit_code_table=<cfqueryparam value = "#unit_code_table#" CFSQLType="CF_SQL_VARCHAR" null="#Not Len(Trim(unit_code_table))#">
		 where event_attribute_type=<cfqueryparam value="#event_attribute_type#" cfsqltype="cf_sql_varchar">
	</cfquery>
	<cflocation addtoken="false" url="CodeTableEditor.cfm?action=edit&tbl=ctcoll_event_att_att">
</cfif>
