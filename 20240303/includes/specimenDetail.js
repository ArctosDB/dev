...
function mapsYo(){
	$("input[id^='coordinates_']").each(function(e){
		...
		// this is async so set a listener, set a max zoom level on fitbounds 
...
jQuery(document).ready(function(){
    ...
    // https://github.com/ArctosDB/arctos/issues/7697 - bump count to 5 
	var ptl="/form/inclMedia.cfm?typ=specimen" + "&q=" + $("#collection_object_id").val() + "&tgt=specMediaDv&rpp=5&pg=1";
