...
<!---- https://github.com/ArctosDB/dev/issues/71 - add a timeout ---->
...
<cfoutput>
	...
	<cfif typ is "taxon">
		...
		<cfquery name="mediaResultsQuery" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#" cachedwithin="#cachetime#" timeout="15">
			select * from (
			   	select
			   		 media_id,
				     media_uri,
