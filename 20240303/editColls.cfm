				...
				<tbody id="sortable">
					<cfloop query="getColls">
						...
						<tr #iif(i MOD 2,DE("class='evenRow'"),DE("class='oddRow'"))# id="row_#i#">
							...
							<td>
								<textarea name="collector_remark_#i#" id="collector_remark_#i#" class="mediumtextarea">#collector_remark#</textarea>
							</td>
							<td>
					...
					<tr class="newRec" id="row_new1">
						...
						<td>
							<textarea name="collector_remark_new1" id="collector_remark_new1" class="mediumtextarea"></textarea>
						</td>
						<td>
					...
					<tr class="newRec" id="row_new2">
						...
						<td>
							<textarea name="collector_remark_new2" id="collector_remark_new2" class="mediumtextarea"></textarea>
						</td>
						<td>
					...
					<tr class="newRec" id="row_new3">
						...
						<td>
							<textarea name="collector_remark_new3" id="collector_remark_new3" class="mediumtextarea"></textarea>
						</td>
						<td>
	...
	<cfoutput>
		<cftransaction>
			...
			<cfloop list="#ROWORDER#" index="i">
				...
				<cfset thisRemark=evaluate("COLLECTOR_REMARK_" & thisID)>
