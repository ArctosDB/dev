...
<cfabort>
<cfoutput>
https://arctos.database.museum/form/inclMedia.cfm?typ=project&q=10003438&tgt=projMedia&rpp=10&pg=2

<cfquery name="d" datasource="uam_god">
select * from cf_ctuser_roles
</cfquery>
...
<cfloop query="d">
    <hr>
    <cfset dtxt=required_reading & chr(13) & text_documentation & chr(13) & av_documentation>

    <cfset lnks="">

    <cfdump var="#dtxt#">

    <cfloop list="#dtxt#" delimiters='"' index="i">
        <br>#i#
        <cfif left(i,4) is 'http'>
            <br>---------#i# is a link
            <cfset lnks=listAppend(lnks, i)>
        </cfif>
    </cfloop>

    <p><cfdump var="#lnks#">

        <cfset lnks=replace(lnks, 'http:', 'https:','all')>

        <cfset lnks=ListRemoveDuplicates(lnks)>

    <p><cfdump var="#lnks#">


        <cfif listFind(lnks, 'https://handbook.arctosdb.org/documentation/sharing-data-and-resources.html')>
            <cfset lnks=listDeleteAt(lnks, listFind(lnks, 'https://handbook.arctosdb.org/documentation/sharing-data-and-resources.html'))>
        </cfif>
        <cfif listFind(lnks, 'http://handbook.arctosdb.org/documentation/sharing-data-and-resources.html')>
            <cfset lnks=listDeleteAt(lnks, listFind(lnks, 'http://handbook.arctosdb.org/documentation/sharing-data-and-resources.html'))>
        </cfif>
        ...
        <cfquery name="up" datasource="uam_god">
            update cf_ctuser_roles set documentation=<cfqueryparam value="#lnks#" cfsqltype="cf_sql_varchar"  null="#Not Len(Trim(lnks))#"> where role_name='#role_name#'
        </cfquery>
</cfloop>
...
/g
          ...
          <cfinvoke component="/component/utilities" method="sanitizesql" returnvariable="x">
             <cfinvokeargument name="inp" value="#c#">
          </cfinvoke>
...
<cfset hpwd=GenerateArgon2Hash('abc123', 'argon2id', 4, 500, 2)>
...
<cfdump var="#hpwd#">
    ...
    <cfset x=Argon2CheckHash('abc123',hpwd)>
...
select * from cf_users where username='dlm'
</cfquery>
...
<cfdump var="#q#">
    ...
    <cfset x=Argon2CheckHash('oe7Ge(-3jSwDS',q.password)>
...
<cfdump var="#q#">
    ...
    <cfset x=Argon2CheckHash('123','$argon2id$v=19$m=500,t=2,p=8$LtnJGx2gbcbz8mOYrQmbdA$ODpO+2umI00aZ229T0nlJbO56qHGduVA/Zi3tywaY1c')>
...
<cfif Argon2CheckHash(pwd, q.password)>
...
$argon2id$v=19$m=500,t=2,p=8$LtnJGx2gbcbz8mOYrQmbdA$ODpO+2umI00aZ229T0nlJbO56qHGduVA/Zi3tywaY1c
$argon2id$v=19$m=500,t=2,p=8$XCZXx22N8S+XiFdIjP4GOg$zUXezacM0q6sA9APUVGU6pNBP7ymjhKoB1eRZFavLAo
$argon2id$v=19$m=500,t=2,p=8$XCZXx22N8S+XiFdIjP4GOg$zUXezacM0q6sA9APUVGU6pNBP7ymjhKoB1eRZFavLAo
$argon2id$v=19$m=500,t=2,p=8$XCZXx22N8S+XiFdIjP4GOg$zUXezacM0q6sA9APUVGU6pNBP7ymjhKoB1eRZFavLAo
...
<cfquery name="q" datasource="uam_god">
select table_name,column_name,data_type,character_maximum_length ,ordinal_position from information_schema.columns where table_name like 'ct%' order by table_name
</cfquery>

<cfquery name="t" dbtype="query">
select table_name from q group by table_name order by table_name
</cfquery>
<cfoutput>
    ...
    <cfloop query="t">
        ...
        <cfquery name="c" dbtype="query">
            select column_name,data_type,character_maximum_length,ordinal_position from q where table_name='#table_name#' order by ordinal_position
        </cfquery>
         <br>

        <br>|column_name|datatype|precision|todo|
        <br>|-----------|---------|-----|------|
        <cfloop query="c">
            <br> |#column_name#|#data_type#|#character_maximum_length#| --- |
        </cfloop>
        <br> | documentation_url | varchar[] | - | add |
        <br> | issue_url | varchar[] | - | add |
        <br>
        <br>------------
        <br>
    </cfloop>
