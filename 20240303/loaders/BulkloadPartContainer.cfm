...
<cfoutput>
	...
	<cfset templateHeader="guid,guid_prefix,other_id_type,other_id_number,partID,part_name,ignore_subsamples,barcode,institution_acronym,new_container_type">
</cfoutput>
...
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>
			...
			<br>(guid, part_name) or (partID) or (other_id_type,other_id_number,part_name) must be provided.
		</td>
	</tr>
	...
	<tr>
		...
		<td>
			...
			<br>(guid, part_name) or (partID) or (guid_prefix,other_id_type,other_id_number,part_name) must be provided.
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>yes</td>
		<td>
			institution_acronym of the container into which the part will be moved.
		</td>
	</tr>
	<tr>
