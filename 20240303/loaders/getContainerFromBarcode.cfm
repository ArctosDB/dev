<!-------What this is and how to use it-------------
	...
	drop table cf_temp_getcontainer;

	create table cf_temp_getcontainer (
		key serial not null,
		...
		status varchar,
		barcode varchar(200),
		institution_acronym varchar(40), 
		container_id int,
		parent_container_id int,
		container_type varchar(4000),
		label varchar(4000),
		description varchar(4000),
		container_remarks varchar(4000),
		orientation varchar(4000),
		number_rows int,
		number_columns int,
		positions_hold_container_type varchar(4000),
		length numeric,
		width numeric,
		height numeric,
		dimension_units varchar(30),
		weight numeric,
		weight_units varchar(4000),
		weight_capacity numeric,
		weight_capacity_units varchar(4000)
	);

	grant select, insert, update, delete on cf_temp_getcontainer to view_container;
	grant select, usage on cf_temp_getcontainer_key_seq to public;



delete from cf_component_loader where data_table='cf_temp_getcontainer';
...
insert into cf_component_loader (
	...
	'Get Container from Barcode',
	'Pull container data from barcode',
	1,
	'autoload_get_container',
	'/loaders/getContainerFromBarcode.cfm',
	'cf_temp_getcontainer', -- the table used by the loader
	10,
	null,
	'view_container',
	null,
...
<cfoutput>
	...
	<cfset templateHeader="barcode,institution_acronym">
</cfoutput>
...
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>yes</td>
		<td>
			Input barcode of the container for which you want information
		</td>
	</tr>
	<tr>
		...
		<td>yes</td>
		<td>
			institution_acronym corresponding to the barcode
		</td>
	</tr>
	<tr>
		<td>status</td>
