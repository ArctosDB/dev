...
delete from cf_component_loader where data_table='cf_temp_container_position';
...
insert into cf_component_loader (
	...
	'Create Position-type containers',
	1,
	'autoload_create_container_position',
	'/loaders/bulkCreateContainerPositions.cfm',
	'cf_temp_container_position',
	10, 
	null,
	'admin_container',
	null,
	'Username has access to corresponding institution'
);
...
<cfoutput>
	...
	---->
	<cfset templateHeader="container_id,barcode,institution_acronym,position_length,position_width,position_height,position_units">
</cfoutput>
<cfsavecontent variable = "defDocTableGuts">
	...
	<tr>
		...
		<td>yes</td>
		<td>
			Institution of all involved containers; this form cannot be used if this consistency does not exist.
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td>position_units</td>
		<td>yes</td>
		<td>
			Units of the positions being created;  <a href="/info/ctDocumentation.cfm?table=ctlength_units">ctlength_units</a>
		</td>
	</tr>
	<tr>
		<td>status</td>
		...
		<div class="inlinedocs">
			...
			<p>
				...
				<ul>
					...
					<li>
						<a href="https://handbook.arctosdb.org/how_to/developer-guide.html##identifier-convention" class="external">Identifier Convention Documentation</a> may be useful in understanding identifiers.
					</li>
				</ul>
			        </p>
			</p>
