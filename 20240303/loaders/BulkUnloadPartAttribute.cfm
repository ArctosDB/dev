<!-------What this is and how to use it-------------
	...
	drop table cf_temp_part_attribute_unloader;

	create table cf_temp_part_attribute_unloader (
		key serial not null,
		partID varchar(120) not null,
	...
	grant select, insert, update, delete on cf_temp_part_attribute_unloader to manage_records;
	grant select, usage on cf_temp_part_attribute_unloader_key_seq to public;

	

delete from cf_component_loader where data_table='cf_temp_part_attribute_unloader';
...
insert into cf_component_loader (
	...
	'Part Attribute Unloader', -- title
	'Remove part attribtues', -- short description of the purpose
	1, -- run_order is a nonunique integer; 1 is as good at anything
	'autounload_part_attribute', -- this will resolve to /ScheduledTasks/componentLoaderComponents/{what you enter here}.cfm
	'/loaders/BulkUnloadPartAttribute.cfm', -- this should be /loaders/something.cfm - migration in process
	'cf_temp_part_attribute_unloader', -- the table used by the loader
...
<cfoutput>
	...
	<cfset templateHeader="partID,attribute_type,attribute_value,status">
</cfoutput>
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>yes</td>
		<td>
			Part from which to remove attributes. 
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>no</td>
		<td>
			value of attribtue to remove; leave blank to remove all attributes of the given type from the part
		</td>
	</tr>
	<tr>
		<td>status</td>
