...
insert into cf_component_loader (
	...
	'Attribute Bulkloader', -- title
	'Bulkload record attributes', -- short description of the purpose
	1, -- run_order is a nonunique integer; 1 is as good at anything
	'autoload_specimen_attribute', -- this will resolve to /ScheduledTasks/componentLoaderComponents/{what you enter here}.cfm
	'/loaders/BulkloadAttributes.cfm', -- this should be /loaders/something.cfm - migration in process
	'cf_temp_attributes', -- the table used by the loader
...
update cf_component_loader set rec_per_run=10,remark='20250115 timeouts with 20'  where loader_template='autoload_specimen_attribute';
