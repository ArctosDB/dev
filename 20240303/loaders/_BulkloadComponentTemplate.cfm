<!-------What this is and how to use it-------------
	...
	IMPORTANT: build tables with all text fields, see https://handbook.arctosdb.org/how_to/developer-guide.html#component-loaders for more info
	...
	*/
		...
		change the version statement below and leave some comments if you change the template
			...
			CHANGELOG
				...
				1.11: https://github.com/ArctosDB/dev/issues/140
					* add a link to identifier convention (not splitting it out, don't need a new thing to find or maintain...)
...
delete from cf_component_loader where data_table='cf_temp_demotable';
