...
-- 202502 timing out with 10 yikes....

update cf_component_loader set rec_per_run=7 , remark='202502 timing out with 10 yikes....' where data_table='cf_temp_identification';

update cf_component_loader set rec_per_run=2 , remark='202502 was timing out with 10 now failing at 7' where data_table='cf_temp_identification';
...
<cfsavecontent variable = "defDocTableGuts">
	...
	<tr>
		...
		<td>no</td>
		<td>
			ISO8601 - <a href="https://handbook.arctosdb.org/documentation/identification.html#made-date" class="external">https://handbook.arctosdb.org/documentation/identification.html#made-date</a>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>no</td>
		<td>
			publicationID example: https://arctos.database.museum/publication/10008808 see also <a href="https://handbook.arctosdb.org/documentation/developer-guide.html#identifier-convention" class="external">https://handbook.arctosdb.org/documentation/developer-guide.html#identifier-convention</a>
		</td>
	</tr>
