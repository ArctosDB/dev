...
<cfquery name="ctagent_name_type" datasource="cf_codetables" cachedwithin="#createtimespan(0,0,60,0)#">
...
<cfoutput>
	...
	<input type="hidden" id="api_key" name="api_key" form="agntSearch" value="#ak.api_key#">
	<div id="pagewrapper">
		<div id="divrow">
			<div id="leftside">
				<div id="td_search">
					<form name="agntSearch" id="agntSearch">
						<fieldset class="compact">
							...
							<div style="display:table;width:100%;">
								<div style="display:table-row">
									<div style="display:table-cell">
										...
										<input type="text" name="anyName" id="anyName" size="40" placeholder="this is the search box you're looking for">
									</div>
									<div style="display:table-cell">
										<label for="include_verbatim">Include verbatim agent?</label>
										<select name="include_verbatim" size="1" id="include_verbatim" style="max-width: 3em;" onchange="setIncludeVerbatim(this.value);">
											<option <cfif session.include_verbatim is "no" > selected="selected" </cfif> value="no">no</option>
							...
							<div style="display:table;width:100%;">
								...
								<div style="display:table-cell">
									<label for="agent_name">Agent Name (prefix with = for exact)</label>
						...
						<fieldset class="compact">
							<label for="address">Contact Information and Identifiers</label>
							<input type="text" name="address" id="address" class="minput" placeholder="any part of any address,url, or identifier">
						</fieldset>
						<fieldset class="compact">
							<div style="display:table;width:100%;">
								<div style="display:table-cell">
