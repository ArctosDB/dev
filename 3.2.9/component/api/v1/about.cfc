...
<cffunction name="api_map" access="remote" returnformat="json" httpMethod="get" queryFormat="column">
	...
	<!---- cataloged record --->
	<!---- variables ---->
	<cfset b.api_path="/component/api/v1/catalog.cfc?method=about">
	...
	<!--- records ---->
	<cfset c.api_path="/component/api/v1/catalog.cfc?method=getCatalogData">
	...
	<cfset d.api_path="/component/api/v1/authority.cfc?method=code_tables">
	...
	<cfset result.endpoint="#Application.serverRootURL#/component/api/v1/about.cfc?method=api_map">
