...
<cfif action is "nothing">
	...
	<cfoutput>
								...
								<tr>
									...
									<td>
										...
										<cfif len(locDet.geopoly) gt 0>
											...
											<select name="use_geo_poly" id="use_geo_poly" onchange="useGeoPoly(this.value);" style="max-width:10em;">
												<option value="">unavaialble see https://github.com/ArctosDB/arctos/issues/6521</option>
												<!----
		...
		<br>NOTE: Refresh can be slow, timeouts are not unexpected, try again, wait, or file an Issue for assistance.
	</cfoutput>
