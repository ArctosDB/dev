<!-------What this is and how to use it-------------
	...
	create table cf_temp_agent (
		...
		curatorial_remarks varchar CHECK (checkfreetext(curatorial_remarks)),
		...
		address_remark_3 varchar CHECK (checkfreetext(address_remark_3)),
		
		address_type_4 varchar REFERENCES ctaddress_type(address_type),
		address_4 varchar,
		address_start_date_4 varchar CHECK (ck_iso8601(address_start_date_4)),
		address_end_date_4 varchar CHECK (ck_iso8601(address_end_date_4)),
		address_remark_4 varchar CHECK (checkfreetext(address_remark_4)),
		
		address_type_5 varchar REFERENCES ctaddress_type(address_type),
		address_5 varchar,
		address_start_date_5 varchar CHECK (ck_iso8601(address_start_date_5)),
		address_end_date_5 varchar CHECK (ck_iso8601(address_end_date_5)),
		address_remark_5 varchar CHECK (checkfreetext(address_remark_5)),
		
		address_type_6 varchar REFERENCES ctaddress_type(address_type),
		address_6 varchar,
		address_start_date_6 varchar CHECK (ck_iso8601(address_start_date_6)),
		address_end_date_6 varchar CHECK (ck_iso8601(address_end_date_6)),
		address_remark_6 varchar CHECK (checkfreetext(address_remark_6)),
...
insert into cf_component_loader (
	...
	'Agent Loader', -- title
	'Agent Loader: Run this after - and only after - the pre-loader has been used.', -- short description of the purpose
	...
	null,
	'manage_agents,manage_records', -- list of roles required to set autoload, delete, etc.
	'manage_agents,manage_records', -- list of roles required to insert data
...
<cfoutput>
	...
	<cfset templateHeader=listappend(templateHeader,'curatorial_remarks')>
