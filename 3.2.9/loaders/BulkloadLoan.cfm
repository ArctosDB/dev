...
create table cf_temp_loan (
	...
	loan_type varchar not null references ctloan_type(loan_type),
	loan_status varchar(255) not null references ctloan_status(loan_status),
	loan_description varchar(4000)  CHECK (checkfreetext(loan_description)),
	nature_of_material varchar(4000) not null CHECK (checkfreetext(nature_of_material)),
	trans_date varchar(30) check (ck_iso8601(trans_date)),
	due_date varchar(30) check (ck_iso8601(trans_date)),
	closed_date date,
	loan_instructions  varchar(4000) CHECK (checkfreetext(loan_instructions)),
	is_public int default 0 check(is_public in (0,1)),
	trans_remarks varchar(4000) CHECK (checkfreetext(trans_remarks)),
	trans_agent_1  varchar(255),
	trans_agent_role_1 varchar(255) references cttrans_agent_role(trans_agent_role),
	trans_agent_2  varchar(255),
	trans_agent_role_2  varchar(255) references cttrans_agent_role(trans_agent_role),
	trans_agent_3  varchar(255),
	trans_agent_role_3  varchar(255) references cttrans_agent_role(trans_agent_role),
	trans_agent_4  varchar(255),
	trans_agent_role_4  varchar(255) references cttrans_agent_role(trans_agent_role),
	trans_agent_5  varchar(255),
	trans_agent_role_5  varchar(255) references cttrans_agent_role(trans_agent_role),
	trans_agent_6  varchar(255),
	trans_agent_role_6  varchar(255) references cttrans_agent_role(trans_agent_role),
	...
	grant select, insert, update, delete on cf_temp_loan to manage_records;
	grant select, usage on cf_temp_loan_key_seq to public;





delete from cf_component_loader where loader_template='autoload_loan';
...
insert into cf_component_loader (
	...
	'Loan Loader', -- title
	'Create usage transactions aka loans', -- short description of the purpose
	1, -- run_order is a nonunique integer; 1 is as good at anything
	'autoload_loan', -- this will resolve to /ScheduledTasks/componentLoaderComponents/{what you enter here}.cfm
	'/loaders/BulkloadLoan.cfm', 
	'cf_temp_loan', -- the table used by the loader
	10, -- 10 is a nice number; this should NOT tax the server, and must complete in under a minute
	null,
	'manage_records,manage_transactions', -- list of roles required to set autoload, delete, etc.
...
<cfoutput>
	...
	<!----
			...
			select string_agg(column_name,',') from information_schema.columns where table_name='cf_temp_loan' and column_name not in ('key','last_ts','username','status');
	---->

	<cfset templateHeader="guid_prefix,loan_number,loan_type,loan_status,loan_description,nature_of_material,trans_date,due_date,closed_date,loan_instructions,trans_remarks,is_public,trans_agent_1,trans_agent_role_1,trans_agent_2,trans_agent_role_2,trans_agent_3,trans_agent_role_3,trans_agent_4,trans_agent_role_4,trans_agent_5,trans_agent_role_5,trans_agent_6,trans_agent_role_6">
</cfoutput>
...
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>yes</td>
		<td>
			collection owning the transaction
		</td>
	</tr>
	<tr>
		<td>loan_number</td>
	...
	<tr>
		...
		<td>yes</td>
		<td>
			 <a href="/info/ctDocumentation.cfm?table=ctloan_type">ctloan_type</a>
		</td>
	</tr>
	<tr>
		<td>loan_status</td>
		<td>yes</td>
		<td>
			 <a href="/info/ctDocumentation.cfm?table=ctloan_status">ctloan_status</a>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>conditionally</td>
		<td>
			 Agent, corresponds with trans_agent_role_n; n<=6.
		</td>
	</tr>
	<tr>
		<td>trans_agent_role_n</td>
		<td>conditionally</td>
		<td>
			 <a href="/info/ctDocumentation.cfm?table=cttrans_agent_role">cttrans_agent_role</a>, corresponds with trans_agent_n; n<=6.
			 <br>NOTE: Username will receive entered by, attempting to set entered by explicitly will fail.
		</td>
	</tr>
	<tr>
		<td>status</td>
