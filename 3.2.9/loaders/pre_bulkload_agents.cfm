...
delete from cf_component_loader where data_table='cf_temp_pre_bulk_agent';
...
insert into cf_component_loader (
	...
	'Preload Agents: Run this before attempting to bulkload Agents. 
	<div class="importantNotification">
	The bulkloader is restricted access. First use this tool, then ask a manage_codetables operator for help finalizing the load.
	<p>(https://github.com/ArctosDB/arctos/issues/7443)</p>
	</div>',
...
update cf_component_loader set rec_per_run=100,remark='100 running in ~20s 202403' where data_table='cf_temp_pre_bulk_agent';
