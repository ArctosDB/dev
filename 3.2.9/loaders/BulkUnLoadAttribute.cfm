<!-------What this is and how to use it-------------
	...
	drop table cf_temp_unload_attribute;

	create table cf_temp_unload_attribute (
		key serial not null,
		guid varchar,
		attribute_type varchar,
		attribute_value varchar,
		attribute_units varchar,
		attribute_date varchar,
		attribute_method varchar,
	...
	grant all on cf_temp_unload_attribute to manage_collection;
	grant select, usage on cf_temp_unload_attribute_key_seq to public;




delete from cf_component_loader where loader_template='autounload_attribute';
...
insert into cf_component_loader (
	...
	'Un-Bulkload Attributes', -- title
	'Bulk Unload Attributes Tool - remove/delete attributes from records. This process is not reversible, proceed with caution.', -- short description of the purpose
	1, -- run_order is a nonunique integer; 1 is as good at anything
	'autounload_attribute', -- this will resolve to /ScheduledTasks/componentLoaderComponents/{what you enter here}.cfm
	'/loaders/BulkUnLoadAttribute.cfm', -- this should be /loaders/something.cfm - migration in process
	'cf_temp_unload_attribute', -- the table used by the loader
...
<cfoutput>
	...
	<cfset templateHeader="guid,attribute_type,attribute_value,attribute_units,attribute_date,attribute_method,attribute_determiner,attribute_remark">
...
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>yes</td>
		<td>
			GUID of the record from which to remove attributes.
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>
			...
			<ol>
				<li>A string; target specific attributes which exactly match the supplied value.</li>
				<li>empty, nothing, NULL, not there: ignore, do not filter using this term.</li>
			</ol>
		</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td>no</td>
		<td>
			Accepts one of three things:
			<ol>
				<li>A string; target specific attributes which exactly match the supplied value.</li>
				<li>empty, nothing, NULL, not there: ignore, do not filter using this term.</li>
				<li>NULL: The string 'NULL' targets only attributes which DO NOT have any information here.</li>
			</ol>
		</td>
	</tr>
	<tr>
