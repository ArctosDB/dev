...
<cfoutput>
	...
	<cfset templateHeader="container_type,barcode,label,description,container_remarks,width,height,length,institution_acronym,number_rows,number_columns,orientation,positions_hold_container_type,weight,weight_units,weight_capacity,weight_capacity_units">
...
<cfsavecontent variable = "defDocTableGuts">
	...
	<tr>
		...
		<td>conditionally</td>
		<td>
			width of container in centimeters; "0" (no quotes) will update to NULL; blank will be ignored (no updates); decimal; (width,height,length) must be given together or not at all	
		</td>
	</tr>
	<tr>
		<td>height</td>
		<td>conditionally</td>
		<td>
			height of container in centimeters; "0" (no quotes) will update to NULL; blank will be ignored (no updates); decimal; (width,height,length) must be given together or not at all	
		</td>
	</tr>
	<tr>
		<td>length</td>
		<td>conditionally</td>
		<td>
			length of container in centimeters; "0" (no quotes) will update to NULL; blank will be ignored (no updates); decimal; (width,height,length) must be given together or not at all	
		</td>
	</tr>
	<tr>
