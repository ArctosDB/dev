...
<cfoutput>
	...
	<cfset templateHeader="barcode,old_container_type,container_type,description,container_remarks,height,length,width,label,number_rows,number_columns,orientation,positions_hold_container_type,weight,weight_units,weight_capacity,weight_capacity_units">
