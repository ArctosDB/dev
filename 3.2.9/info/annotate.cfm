...
<cfoutput>
	...
	<cfif listlen(v) eq 1>
		...
		<div class="friendlyNotification">
			If you are uncomfortable reporting harmful content in public annotations please send an email to dei_contact@arctosdb.org instead of adding an annotation here.
		</div>
