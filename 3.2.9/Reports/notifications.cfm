<cfinclude template="/includes/_header.cfm">
	...
	<cfoutput>
		...
		<p>
			Found #user_notification.recordcount# notifications.<cfif user_notification.recordcount is 200> You have more notifications than this form can display at once. You may limit what's displayed by using the search pane at the top of the page.</cfif>
		</p>
					...
					<tr id="tr_#notification_id#" class="#thisClass#">
						...
						<td valign="top">
							<div class="notificationContentDiv">
								#content#
								<!---------#REReplaceNoCase(content, "<[^[:space:]][^>]*>", "", "ALL")#
