	...
	<cfloop query="d">
		<cftransaction>
			<cfstoredproc
					...
					<cfprocparam cfsqltype="cf_sql_varchar" value="#barcode#" null="#Not Len(Trim(barcode))#"><!----child_barcode---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="#parent_barcode#" null="#Not Len(Trim(parent_barcode))#"><!---- parent_barcode ---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="" null="true"><!---- child_container_type ---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="" null="true"><!---- parent_container_type ---->
			</cfstoredproc>
		...
		<cftransaction>
			<cfif new_parent_c_type is "freezer box" and len(new_h) gt 0 and len(new_w) gt 0 and len(new_l) gt 0>
				...
				<cfstoredproc
					...
					<cfprocparam cfsqltype="cf_sql_int" value="#updatingpgarent.container_id#"><!----v_container_id---->
					<cfprocparam cfsqltype="cf_sql_int" value="#updatingpgarent.parent_container_id#"><!----v_parent_container_id---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="#new_parent_c_type#" null="#Not Len(Trim(new_parent_c_type))#"><!----v_container_type---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="#updatingpgarent.label#" null="#Not Len(Trim(updatingpgarent.label))#"><!---- v_label ---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="#updatingpgarent.description#" null="#Not Len(Trim(updatingpgarent.description))#"><!---- v_description ---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="#updatingpgarent.CONTAINER_REMARKS#" null="#Not Len(Trim(updatingpgarent.CONTAINER_REMARKS))#"><!---- v_container_remarks ---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="#updatingpgarent.barcode#" null="#Not Len(Trim(updatingpgarent.barcode))#"><!---- v_barcode ---->
					<cfprocparam cfsqltype="cf_sql_int" value="#new_w#" null="#Not Len(Trim(new_w))#"><!---- v_width ---->
					<cfprocparam cfsqltype="cf_sql_int" value="#new_h#" null="#Not Len(Trim(new_h))#"><!---- v_height ---->
					<cfprocparam cfsqltype="cf_sql_int" value="#new_l#" null="#Not Len(Trim(new_l))#"><!---- v_length ---->
					<cfprocparam cfsqltype="cf_sql_int" value="#updatingpgarent.number_rows#" null="#Not Len(Trim(updatingpgarent.number_rows))#"><!---- v_number_rows ---->
					<cfprocparam cfsqltype="cf_sql_int" value="#updatingpgarent.number_columns#" null="#Not Len(Trim(updatingpgarent.number_columns))#"><!---- v_number_columns ---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="#updatingpgarent.orientation#" null="#Not Len(Trim(updatingpgarent.orientation))#"><!---- v_orientation ---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="#updatingpgarent.position_holds_container_type#" null="#Not Len(Trim(updatingpgarent.position_holds_container_type))#"><!---- v_posn_hld_ctr_typ ---->
					<cfprocparam cfsqltype="cf_sql_varchar" value="#updatingpgarent.institution_acronym#" null="#Not Len(Trim(updatingpgarent.institution_acronym))#"><!---- v_institution_acronym ---->
				</cfstoredproc>
				...
				<cfloop from="1" to="#listlen(bclist)#" INDEX="I">
					...
					<cfif len(thisBarcode) gt 0>
						...
						<cfstoredproc
							...
							password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#"
							procedure="moveContainerByBarcode">
							<cfprocparam cfsqltype="cf_sql_varchar" value="#thisBarcode#"  null="#Not Len(Trim(thisBarcode))#">
							<cfprocparam cfsqltype="cf_sql_varchar" value="#parent_barcode#"  null="#Not Len(Trim(parent_barcode))#">
							<cfprocparam cfsqltype="cf_sql_varchar" value="#new_child_c_type#"  null="#Not Len(Trim(new_child_c_type))#">
							<cfprocparam cfsqltype="cf_sql_varchar" value="#new_parent_c_type#"  null="#Not Len(Trim(new_parent_c_type))#">
						</cfstoredproc>
						<!----
							<cfquery name="ins" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
							update
