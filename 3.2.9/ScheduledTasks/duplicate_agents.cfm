			...
			<cfloop query="bads">
				...
				<cftransaction>
					<cftry>
						...
						<cfif IsJson(agent_merge_history.summary)>
						...
						<!----
							https://github.com/ArctosDB/arctos/issues/6947
							now nuke whatever we just added to unknown
						---->

						<cfquery name="agent_status" datasource="uam_god">
							delete from  agent_status where agent_id = <cfqueryparam value = "0" CFSQLType = "cf_sql_int">
						</cfquery>
						de-unknowned agent_status<br>

						<cfquery name="agent_status" datasource="uam_god">
							delete from  address where agent_id = <cfqueryparam value = "0" CFSQLType = "cf_sql_int">
						</cfquery>
						de-unknowned address<br>
						...
						.........rollback...
							<cftransaction action="rollback">
								...
								<cfquery name="fail_stop" datasource="uam_god">
									update cf_dup_agent set status='stuck_fail' where agent_id = <cfqueryparam value = "#bads.agent_id#" CFSQLType = "cf_sql_int">
								</cfquery>
								<cfsavecontent variable="msg">
									<br>Agent merger for #bads.agent_pref_name# --> #bads.rel_agent_pref_name# failed and was rolled back.
									<br>

									cleanup SQL: update cf_dup_agent set last_date=current_date - interval '1 month',status='pass_email_sent' where AGENT_ID=#bads.agent_id#;
