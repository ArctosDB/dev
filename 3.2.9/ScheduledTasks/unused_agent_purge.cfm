...
insert into temp_used_agent_id (select distinct created_agent_id from cataloged_item;
insert into temp_used_agent_id (select distinct created_agent_id from specimen_part;
