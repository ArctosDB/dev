...
<cfoutput>
	...
	<cfset templateHeader="higher_geog,locality_name,spec_locality,dec_lat,dec_long,minimum_elevation,maximum_elevation,orig_elev_units,min_depth,max_depth,depth_units,max_error_distance,max_error_units,datum,locality_remarks,georeference_protocol,utm_zone,utm_ew,utm_ns,use_geography_polygon">
</cfoutput>
