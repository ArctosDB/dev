<!-------What this is and how to use it-------------
	...
	grant select, insert, update, delete on cf_temp_taxon_name to manage_collection;
...
<cfset title="Bulkload Taxon Names">
<cfset thisFormFile="BulkloadTaxonomy.cfm">
<cfset thisFormName="Bulkload Taxon Names">
<cfset thisFormPurpose='This tool allows Arctos operators with the <a href="/Admin/user_roles.cfm">Manage Collection</a> role to create and review taxon names.'>
<cfset thisTable="cf_temp_taxon_name">
<cfset thisTemplateName="BulkloadTaxonomyTemplate.csv">
<cfset thisDownloadName="BulkloadTaxonomyData.csv">
<cfset templateHeader="scientific_name,name_type">
