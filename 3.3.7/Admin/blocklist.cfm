					...
					<cfloop query="dip">
						<tr>
							<td valign="top">
								...
								<ul>
									<li>
										<a class="external" target="_blank" href="http://whatismyipaddress.com/ip/#ip#">[ @whatismyipaddress ]</a>
									</li>
									<li>
										<a class="external" target="_blank" href="https://www.ipalyzer.com/#ip#">[ @ipalyzer ]</a>
									</li>
								</ul>
							</td>
							<td>#event_count#</td>
