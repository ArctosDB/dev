...
<!----
	...
	---->
		<cfquery name="ot" datasource="uam_god">
			delete from cf_genbank_crawl where owner=<cfqueryparam value="#guid_prefix#" cfsqltype="cf_sql_varchar"> and 
				query_type=<cfqueryparam value="#thisRunType#" cfsqltype="cf_sql_varchar">
		</cfquery>
