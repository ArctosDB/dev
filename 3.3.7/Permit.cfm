...
<cfif action is "search">
	...
	<cfoutput>
		...
		<cfquery name="matchPermit" datasource="user_login" username="#session.dbuser#" password="#decrypt(session.epw,session.sessionKey,'AES/CBC/PKCS5Padding','hex')#">
			...
			<cfloop query="matchPermit">
				<tr #iif(i MOD 2,DE("class='evenRow'"),DE("class='oddRow'"))#>
					...
					<td>
						...
						<div>
							<a href="/transactionSearch.cfm?action=srch&permit_id=#permit_id#">Using&nbsp;Transactions</a>
						</div>
					</td>
				</tr>
				<cfset i=i+1>
