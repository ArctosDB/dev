...
<cfif action is "nothing">
	...
	<cfoutput>
		...
		<cfset theColumnList="began_date,ended_date,verbatim_date,received_date,disposition,condition,attrcnt,attr1,attr2,attr3,attr4,attr5,part_id,sampled_from_obj_id,bc1,lbl1,part_remark,higher_geog,spec_locality,item_remarks,item_instructions">
				...
				<ul>
					...
					<li>
						...
						<cfif loanDetails.loan_type is 'data'>
							<div class="importantNotification">
								This form is not suitable for data loans.
							</div>
							<cfabort>
						</cfif>
					</li>
