<!-------What this is and how to use it-------------
	...
	create table cf_temp_container_position (
		key serial not null,
		container_id int,
		barcode varchar,
		position_width double precision,
		position_length double precision,
		position_height double precision,
		username varchar not null default session_user,
		last_ts timestamp default current_timestamp,
		status varchar
	);

	grant select, insert, update, delete on cf_temp_container_position to admin_container;
	grant select, usage on cf_temp_container_position_key_seq to public;
...
delete from cf_component_loader where loader_template='autoload_create_container_position';
...
insert into cf_component_loader (
	...
	'bulk-create container positions',
	99,
	'autoload_create_container_position',
	'/tools/cf_temp_container_position.cfm',
...
<cfoutput>
	...
	<cfset title="Bulkload Container Positions">
	<cfset thisFormFile="bulkCreateContainerPositions.cfm">
	<cfset thisFormName="Bulkload Container Positions Tool">
	<cfset thisFormPurpose='This tool allows Arctos operators with <a href="/Admin/user_roles.cfm">role(s)</a> (#required_roles#) to create and review Container Positions.'>
	<cfset thisTable="cf_temp_container_position">
	<cfset thisTemplateName="bulkloadCreateContainerPositions.csv">
	<cfset thisDownloadName="bulkloadCreateContainerPositionsData.csv">
	<cfset templateHeader="container_id,barcode,position_width,position_length,position_height">
...
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>conditionally</td>
		<td>
			One of (container_id,barcode) must be provided to identify the parent container. The parent container must be set up for appropriate position layout and must have dimensional information for this form to work.
		</td>
	</tr>
	<tr>
		<td>barcode</td>
	...
	<tr>
		<td>position_width</td>
		<td>yes</td>
		<td>
			Width in centimeters of the positions being created
		</td>
	</tr>
	<tr>
		<td>position_length</td>
		<td>yes</td>
		<td>
			Length in centimeters of the positions being created
		</td>
	</tr>
	<tr>
		<td>position_height</td>
		<td>yes</td>
		<td>
			Height in centimeters of the positions being created
		</td>
	</tr>
	<tr>
		<td>status</td>
