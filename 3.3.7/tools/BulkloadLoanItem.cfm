...
<cfset templateHeader="part_id,guid,guid_prefix,other_id_type,other_id_number,part_barcode,part_name,ignore_subsample_in_finding,create_subsample,loan_item_description,loan_item_remarks,loan_item_instructions,loan_guid_prefix,loan_number,update_part_disposition,update_part_condition">
</cfoutput>
...
<cfsavecontent variable = "defDocTableGuts">
	<tr>
		...
		<td>conditionally</td>
		<td>
			part_id, GUID, guid_prefix+other_id_type+other_id_number, or part_barcode may be used to specify the catalog record.
			<br>Part_id (specimen_part.collection_object_id) is available from SpecimenResults/Manage/PartsTableDownload.
			<br>When part_id is given, guid, guid_prefix, other_id_type, other_id_number, part_barcode, part_name, and ignore_subsample_in_finding are ignored.
		</td>
	</tr>
	<tr>
		<td>guid</td>
